...
const specAssetUrlModules = import.meta.glob("SpecFeature/**/Assets/**/*.{svg,png,jpg,jpeg,gif,webp,avif,ico,bmp}", { eager: true, import: "default", query: "?url" }) as Record<string, SlotAssetUrl>;
