...
export abstract class IDataProvider<T>
{
    ...
    public async fetchList(condition?: QueryListParam): Promise<ApiResponse<T[]>>
    {
        return await this.doFetchList(condition);
    }

    public async fetchListCount(condition?: QueryListParam): Promise<ApiResponse<number>>
    {
    ...
    protected abstract doFetchList(condition?: QueryListParam): Promise<ApiResponse<T[]>>;
    protected abstract doFetchListCount(condition?: QueryListParam): Promise<ApiResponse<number>>;
