        ...
        <ul className={prop.Style.UlStyle} id="Main_Tab" role="tablist">
            {Object.entries(prop.item).map(([key, label],idx) => {
                ...
                <li key={key} className={prop.Style.LiStyle} role="presentation">
                    <button className={clsx(prop.Style.BtnStyle, isActive && "active")} data-bs-toggle="tab" data-bs-target={`#Tab_TWEN_${key}`} type="button" role="tab" aria-selected={isActive ? "true" : "false"}>
