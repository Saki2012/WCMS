        ...
        <div className="row mx-0 px-0">
            <nav className="d-flex align-content-center w-100 px-0" aria-label="Page navigation">
                <ul className={style.ul}>
                    <li className={clsx(style.li, currentPage === 1 ? "disabled" : "")}>
                        <a onClick={() => currentPage !== 1 && onPageChange(1)} className={clsx(style.aLink, currentPage === 1 ? "disabled" : "")} aria-disabled={currentPage === 1} aria-label="Previous" title="第一頁">
                    ...
                    <li className={clsx(style.li, currentPage === totalPages ? "disabled" : "")}>
                        <a onClick={() => currentPage !== totalPages && onPageChange(currentPage + 1)} className={clsx(style.aLink, currentPage === totalPages ? "disabled" : "")} aria-disabled={currentPage === totalPages} aria-label="Next" title="下一頁">
                            <span aria-hidden="true"><i className={style.NextPage}></i></span>
                        </a>
                    </li>
                    <li className={clsx(style.li, currentPage === totalPages ? "disabled" : "")}>
                        <a onClick={() => currentPage !== totalPages && onPageChange(totalPages)} className={clsx(style.aLink, currentPage === totalPages ? "disabled" : "")} aria-disabled={currentPage === totalPages} aria-label="Last" title="最後一頁">
