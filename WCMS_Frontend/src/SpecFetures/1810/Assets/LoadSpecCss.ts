// src/SpecFetures/1810/Assets/LoadSpecCss.ts

// === Bootstrap 核心 ===
import "./Client/Content/bootstrap-5.1.1/css/bootstrap.min.css";
...
import "./Client/Content/venobox-master/dist/venobox.min.css";

// === 特效 / Marquee / Slide-bar / WOW ===
import "./Client/Content/animate/animate.css";
import "./Client/Content/marquee/marquee-left-loop.css";
import "./Client/Content/slide-bar/slide-bar.css";
import "./Client/Content/wow/animate.css";

// === 其他 ===
import "./Client/Content/Sitemap/Sitemap.css";
import "./Client/Content/print/print.css"; // 對應原本的 Content/print.css
