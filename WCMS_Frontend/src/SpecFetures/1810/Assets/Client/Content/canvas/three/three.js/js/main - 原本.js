...
var TweenLite = (function(window, moduleName) {
		...
		var _namespace = function(ns) {
			 ...
			 * </script>
			 * <script src="../../../canvas/www.tapple.co.jp/wp-content/themes/MatchingAgent/assets/js/js/greensock/v1.7/TweenMax.js"></script>
			 * <script>
			 *     window.GreenSockGlobals = window._gsQueue = window._gsDefine = null; //reset it back to null (along with the special _gsQueue variable) so that the next load of TweenMax affects the window and we can reference things directly like TweenLite.to(...)
			 * </script>
			 * <script src="../../../canvas/www.tapple.co.jp/wp-content/themes/MatchingAgent/assets/js/js/greensock/v1.6/TweenMax.js"></script>
			 * <script>
  ...
  _createClass(PageChangeAnime, [{
    ...
    value: function inPC() {
      ...
      if (window.finishedFirstLoad == undefined) {
        ...
        var load = document.querySelector('.l-load');
