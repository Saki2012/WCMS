...
var TweenLite = (function(window, moduleName) {
		...
		var _namespace = function(ns) {
			 ...
			 * </script>
			 * <script src="../../../www.tapple.co.jp/wp-content/themes/MatchingAgent/assets/js/js/greensock/v1.7/TweenMax.js"></script>
			 * <script>
			 *     window.GreenSockGlobals = window._gsQueue = window._gsDefine = null; //reset it back to null (along with the special _gsQueue variable) so that the next load of TweenMax affects the window and we can reference things directly like TweenLite.to(...)
			 * </script>
			 * <script src="../../../www.tapple.co.jp/wp-content/themes/MatchingAgent/assets/js/js/greensock/v1.6/TweenMax.js"></script>
			 * <script>
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Cling; });
...
var isIE = __webpack_require__(/*! ./utils/isIE */ "./src/js/components/utils/isIE.js"),
    isEdge = __webpack_require__(/*! ./utils/isEdge */ "./src/js/components/utils/isEdge.js");
...
/*#__PURE__*/
function () {
  function Cling(controller) {
    _classCallCheck(this, Cling);
    ...
    this.clingAnim = {
      ...
      onMouseMove: function onMouseMove() {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(_this.cling, 0.2, {
      ...
      onMouseLeave: function onMouseLeave(el) {
        ...
        if (_this.cling) {
          gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(_this.cling, 0.6, {
            // rotation: '0deg',
            x: '0px',
            y: '0px',
  ...
  _createClass(Cling, [{
    ...
    key: "onMouseEnterLeave",
    value: function onMouseEnterLeave() {
      if (!this.isActive) return;

      var _this = this;

      Array.from(document.querySelectorAll('.js-cling'), function (elm) {
...
/* harmony import */ var _InView_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./InView.js */ "./src/js/components/InView.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var UserAgentChecker = __webpack_require__(/*! ./UserAgentChecker.js */ "./src/js/components/UserAgentChecker.js").default,
    ReplaceImg = __webpack_require__(/*! ./ReplaceImg.js */ "./src/js/components/ReplaceImg.js").default,
    Hover = __webpack_require__(/*! ./common/Hover.js */ "./src/js/components/common/Hover.js").default,
    // Click = require('./utils/Click.js').default,
SmoothScroll = __webpack_require__(/*! ./common/SmoothScroll.js */ "./src/js/components/common/SmoothScroll.js").default,
    Polyfills = __webpack_require__(/*! ./common/Polyfills.js */ "./src/js/components/common/Polyfills.js").default,
    Pjax = __webpack_require__(/*! ./Pjax.js */ "./src/js/components/Pjax.js").default,
    UIDelayStepper = __webpack_require__(/*! ./UIDelayStepper.js */ "./src/js/components/UIDelayStepper.js").default,
    Preload = __webpack_require__(/*! ./Preload */ "./src/js/components/Preload.js").default,
    PreloadAll = __webpack_require__(/*! ./PreloadAll */ "./src/js/components/PreloadAll.js").default,
    VertialScroll = __webpack_require__(/*! ./VertialScroll */ "./src/js/components/VertialScroll.js").default,
    PageChangeAnime = __webpack_require__(/*! ./PageChangeAnime */ "./src/js/components/PageChangeAnime.js").default,
		// cara 取消
    // fluidAnimation = require('./FluidAnimation').default,
		VueCommon = __webpack_require__(/*! ./VueCommon */ "./src/js/components/VueCommon.js").default,
		// cara 取消
    // Hamburger = __webpack_require__(/*! ./Hamburger */ "./src/js/components/Hamburger.js").default,
    Cling = __webpack_require__(/*! ./Cling */ "./src/js/components/Cling.js").default,
		// cara 取消
    // LandscapeAct = __webpack_require__(/*! ./LandscapeAct */ "./src/js/components/LandscapeAct.js").default,
		// cara 取消
    // ScrollManager = require('./scrollManager/ScrollManager').default,
limitScrollOff = __webpack_require__(/*! ./common/LimitScrollOff.js */ "./src/js/components/common/LimitScrollOff.js").default;
...
function () {
  ...
  _createClass(Controller, [{
    ...
    value: function onetime() {
      ...
      Polyfills();
      this.pjax.on();
      this.pjax.set(['.js-pjax', 'a.page-numbers', '.js-pjax-onece']);
    ...
    value: function common() {
      ...
      Preload(this);
      setTimeout(function () {
        _this2.vertialScroll.init();
      }, 100);
      this.cling.onMouseEnterLeave();
    }
  }, {
    key: "page",
    value: function page() {
      ...
      switch (window.pageId) {
        case 'index':
          __webpack_require__(/*! ../init/Top.js */ "./src/js/init/Top.js").default();

          break;
        // case 'about': require('../init/About.js').default(); break;

        case 'company':
          __webpack_require__(/*! ../init/Company.js */ "./src/js/init/Company.js").default();

          break;

        case 'contact':
          __webpack_require__(/*! ../init/Contact.js */ "./src/js/init/Contact.js").default(this);
...
/***/ "./src/js/components/FluidAnimation.js":
/*!*********************************************!*\
  !*** ./src/js/components/FluidAnimation.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var _THREE = THREE,
      ...
      PlaneBufferGeometry = _THREE.PlaneBufferGeometry,
      ShaderMaterial = _THREE.ShaderMaterial;
  var _POSTPROCESSING = POSTPROCESSING,
      EffectComposer = _POSTPROCESSING.EffectComposer,
      RenderPass = _POSTPROCESSING.RenderPass,
      BloomPass = _POSTPROCESSING.BloomPass,
  ...
  /*#__PURE__*/
  function (_Pass) {
    _inherits(MetaballPass, _Pass);

    function MetaballPass() {
      var _this;

      _classCallCheck(this, MetaballPass);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(MetaballPass).call(this));
      _this.name = 'MetaballPass';
      _this.needsSwap = true;
      _this.material = new ShaderMaterial(metaballShader);
      _this.quad.material = _this.material;
      return _this;
    }

    _createClass(MetaballPass, [{
      key: "render",
  ...
  function () {
    function Webgl(w, h) {
      ...
      this.camera = new PerspectiveCamera(50, w / h, 2, 20); // this.camera.position.set(0, 0, 10);

      this.camera.position.set(0, 0, 10);
      this.dom = this.renderer.domElement; // this.dom = document.querySelector('#container')
    ...
    _createClass(Webgl, [{
      ...
      value: function initPostprocessing() {
        this._composer = new EffectComposer(this.renderer, {// stencilBuffer: true,
          // depthTexture: true,
        }); // PASSES

        var renderPass = new RenderPass(this.scene, this.camera); // renderPass.renderToScreen = true;

        this._composer.addPass(renderPass);

        var incrustationPass = new MetaballPass();
  ...
  var webgl = new Webgl(windowWidth, windowHeight); // document.body.appendChild(webgl.dom);

  document.querySelector('.l-bg').appendChild(webgl.dom);
  /* ---- CREATING ZONE ---- */
  ...
  function (_Mesh) {
    ...
    function Bubble() {
      ...
      var geom = new PlaneBufferGeometry(2, 2, 2, 2);
      ...
      _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Bubble).call(this, geom, material));
  ...
  var bubbles = []; // for (let i = 0; i < 65; i++) {

  var num = window.isPC ? 50 : 35;
  var size = window.isPC ? 1.3 : 1.4;

  for (var i = 0; i < num; i++) {
    var bubble = new Bubble(); // バブルの大きさ

    bubble.scale.multiplyScalar(getRandomFloat(size, size));
    bubbles.push(bubble);
    bubble.position.set(getRandomFloat(-6, 6), getRandomFloat(-5, 5), getRandomFloat(-6, 6));
    webgl.add(bubble);
  }
  /* ---- CREATING ZONE END ---- */
  ...
  function () {
    ...
    _createClass(CameraMouseControl, [{
      key: "handleMouseMove",
      value: function handleMouseMove(event) {// this.speed = ((event.clientX / window.innerWidth) - 0.5) * 0.08;
      ...
      value: function update() {
        ...
        if (!this.show) {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].from(this.camera.position, 2, {
            z: 50,
            y: 50,
            x: -50,
          ...
          gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(document.querySelector('.l-bg'), 0.4, {
            opacity: 1, //Cara 0改1 //20230822
            ease: Power1.easeOut,
            delay: 1.8,
            onComplete: function onComplete() {
              gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(document.querySelector('.l-bg'), 0.6, {
                opacity: 1,
                ease: Power1.easeOut,
                delay: 0.2
              });
          ...
          this.t += 0.1 * this.speed;
          this.camera.position.z = Math.cos(this.t) * 10;
          this.camera.position.x = Math.sin(this.t) * 10; // this.camera.rotation.z = 10.3;
          // this.camera.position.x += (this.position.x - this.camera.position.x) * 0.1;
          // this.camera.position.y += (this.position.y - this.camera.position.y) * 0.01;

          for (var _i = 0; _i < bubbles.length; _i++) {
            bubbles[_i].lookAt(this.camera.position);
          }
  ...
  //   var elm = document.querySelector('.l-landscape');
  ...
  // if (window.isSP) window.addEventListener('orientationchange', orientationchange);
  // if (window.isPC) window.addEventListener('resize', onResize);
  // if (window.isPC) window.addEventListener('orientationchange', onResize);
...
// "use strict";
// // __webpack_require__.r(__webpack_exports__);
// // var menuIcon = document.querySelector('.l-gnav-menu-icon'),
// //     lineOpen = menuIcon.querySelectorAll('.line--open'),
// //     lineClose = menuIcon.querySelectorAll('.line--close'),
// //     lineSlash = menuIcon.querySelector('.line--slash'),
// //     lineBackSlash = menuIcon.querySelector('.line--back-slash'),
// //     header = document.querySelector('.l-header'),
// //     gnav = header.querySelector('.l-header__gnav'),
// //     navItem = gnav.querySelectorAll('.link'),
// //     body = document.querySelector('body'); // btnLink = navMenu.querySelector('.btn');
...
// //           body.setAttribute('data-scroll-current', scrollTop);
// //           body.style.marginTop = "-".concat(scrollTop, "px");
...
// //   function close(elm) {
// //     elm.classList.add('is-close');
// //     gnav.classList.add('is-close'); // this.classList.add('is-open')

// //     setTimeout(function () {
// //       elm.classList.remove('is-open');
// //       elm.classList.remove('is-close');
// //       gnav.classList.remove('is-open');
// //       gnav.classList.remove('is-close');
// //       gnav.style.display = 'none';
// //     }, 800);
// //     body.style.marginTop = 0;
// //     body.style.position = 'static';
// //     var scrollTop = body.getAttribute('data-scroll-current');
// //     window.scrollTo(0, scrollTop);
// //   }

// //   function linkClick() {
// //     Array.from(navItem, function (elm) {
...
//     this.headerFixed = document.querySelector('.l-header--fixed');
...
//       if (window.isPC) this.scrollPC();
//       if (window.isSP) this.scrollSP();
//     }
//   }, {
//     key: "scrollSP",
//     value: function scrollSP() {
//       var scrollTopAfter = document.documentElement.scrollTop || document.body.scrollTop;

//       if (this.scrollTop != scrollTopAfter) {
//         this.isScrollDown = this.scrollTop < scrollTopAfter;
//       }

//       this.scrollTop = scrollTopAfter;

//       if (this.scrollTop > 100) {
//         this.header.style.background = "rgba(255, 255, 255, 1)";
//         this.header.style.boxShadow = "6px 6px 40px rgba(0,0,0,.08)";
//       } else {
//         this.header.style.background = "rgba(255, 255, 255, 0)";
//         this.header.style.boxShadow = "6px 6px 40px rgba(0,0,0,.0)";
//       }
//     }
//   }, {
//     key: "scrollPC",
//     value: function scrollPC() {
//       var scrollTopAfter = document.documentElement.scrollTop || document.body.scrollTop;
...
//       if (this.scrollTop > 100) {
//         this.hiddenHeader(); // this.hiddenFixedHeader()
//       } else {
//         this.showHeader();
...
//         if (this.isScrollDown) this.hiddenFixedHeader();
//         if (!this.isScrollDown) this.showFixedHeader();
//       } else {
//         if (this.scrollTop < 300) this.hiddenFixedHeader();
//       }
//     }
//   }, {
//     key: "showHeader",
...
//       gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(this.header, 0.3, {
//         opacity: "1",
//         y: '0px'
//       });
//     }
...
//       this.headerFixed.style.display = "flex";
//       gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(this.headerFixed, 0.3, {
//         opacity: "1",
//         y: '0px'
//       });
//     }
//   }, {
//     key: "hiddenFixedHeader",
//     value: function hiddenFixedHeader() {
//       var _this2 = this;
...
//         y: '-60px',
//         onComplete: function onComplete() {
//           _this2.headerFixed.style.display = "none";
//         }
//       });
//     }
//   }, {
...
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var _InViewBase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./InViewBase */ "./src/js/components/InViewBase.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var InView = function InView() {
  ...
  var inView = new _InViewBase__WEBPACK_IMPORTED_MODULE_1__["default"]('.js-inview-item');
  inView.setOffset(10); // offsetの設定

  inView.enter(function (elm) {
    if (!elm.classList.contains('is-shown')) {
      elm.classList.add('is-shown'); // メインコンテンツ

      var elmChildren = elm.querySelectorAll('.js-inview-item-child');
      var inviewStyle = elm.dataset ? elm.dataset.inviewStyle : null;

      switch (inviewStyle) {
        case 'section-frame':
          elm.classList.add('is-shown'); // TweenMax.set(this.elm, {transitionDuration: '0.9s', opacity: 1, transform: 'translate3d(0,-20px,0)', transitionTimingFunction: 'cubic-bezier(0.3,0.4,0.1,1)', transitionDelay: '0.1s'})

          break;

        case 'section-title':
          setTimeout(function () {
            elm.classList.add('is-shown'); // let chars = elm.querySelectorAll('.delay-elem')
            // let line = elm.querySelector('.line')
            // TweenMax.set(chars, {transform: 'matrix(1, 0, 0, 1, 0, 0)', opacity: '1'})
            // TweenMax.set(line, {transform: 'translate3d(0,0,0) scsleX(1)', opacity: '1', transitionDelay: '0.1s'})
          }, 100);
          break;
        ...
        //   setTimeout(()=>{
        //     TweenMax.set(this.elm, {transitionDuration: '0.9s',transitionTimingFunction: 'cubic-bezier(0.3,0.4,0.1,1)' ,transform: 'translate3d(0,0,0)', opacity: '1'})
        //   },300)
        //   break;

        default:
          var _loop = function _loop() {
            var elmchild = elmChildren[i]; // elmchild.classList.add('is-shown');

            var inviewStyle = elmchild.dataset ? elmchild.dataset.inviewStyle : null;

            switch (inviewStyle) {
              case 'show-up':
                setTimeout(function () {
                  elmchild.classList.add('is-shown'); // TweenMax.set(elmchild, {transitionDuration: '0.9s',transitionTimingFunction: 'cubic-bezier(0.3,0.4,0.1,1)' ,transform: 'translate3d(0,0,0)', opacity: '1'})
                }, 600);
                break;
...
/***/ "./src/js/components/InViewBase.js":
/*!*****************************************!*\
  !*** ./src/js/components/InViewBase.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return InViewBase; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var debounce = __webpack_require__(/*! ./utils/debounce */ "./src/js/components/utils/debounce.js");

var InViewBase =
/*#__PURE__*/
function () {
  function InViewBase(target, offset) {
    _classCallCheck(this, InViewBase);

    this.targets = Array.from(document.querySelectorAll(target), function (e) {
      return e;
    });
    this.offset = 0;
  ...
  _createClass(InViewBase, [{
    ...
    key: "enter",
    value: function enter(calback) {
      var _this = this;

      this.callbackEnter = calback; // ロード時
      ...
      window.addEventListener('resize', debounce(function () {
        _this.windowH = window.innerHeight;
    ...
    value: function enterAction() {
      ...
      this.targets.forEach(function (target) {
        try {
          ...
          var targetTop = rect.top + _this2.scrollTop;

          if (_this2.scrollTop + _this2.windowH > targetTop + _this2.offset) {
            // ターゲットが見える瞬間
            _this2.enterEvent(target);
          }
        } catch (e) {}
      });
    }
...
// /***/ "./src/js/components/LandscapeAct.js":
// /*!*******************************************!*\
//   !*** ./src/js/components/LandscapeAct.js ***!
//   \*******************************************/
// /*! exports provided: default */
...
function () {
  ...
  _createClass(Map, [{
    ...
    value: function setMap() {
      ...
      var icon = new google.maps.MarkerImage('/assets/images/common/icn_map.png',
      /*アイコンの場所*/
      new google.maps.Size(90, 93),
      /*アイコンのサイズ*/
      new google.maps.Point(0, 0)
      /*アイコンの位置*/
      );
      var latlng = new google.maps.LatLng(35.662437, 139.696102);
      /*表示したい場所の経度、緯度*/
...
/***/ "./src/js/components/PageChangeAnime.js":
/*!**********************************************!*\
  !*** ./src/js/components/PageChangeAnime.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PageChangeAnime; });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var fluidAnimation = __webpack_require__(/*! ./FluidAnimation */ "./src/js/components/FluidAnimation.js").default;

var UIDelayStepper2 = __webpack_require__(/*! ./UIDelayStepper2.js */ "./src/js/components/UIDelayStepper2.js").default;
...
/*#__PURE__*/
function () {
  function PageChangeAnime(controller) {
    _classCallCheck(this, PageChangeAnime);

    this.controller = controller;
    this.page = document.querySelector('.l-page-wrapper');
    // var header = document.querySelector('.l-header');
    // this.logo = header.querySelector('.header__logo');
    // this.gnav = header.querySelector('.header__gnav');
    // this.gnavList = this.gnav.querySelectorAll('.item');
    // this.headerFixed = document.querySelector('.l-header--fixed');
    // this.headerFixedGnav = this.headerFixed.querySelector('.header__gnav');
    // this.headerFixedGnavList = this.headerFixedGnav.querySelectorAll('.item');
    // this.headerFixedBg = this.headerFixed.querySelector('.header--fixed__bg');
    // this.headerFixedLogo = this.headerFixed.querySelector('.header__logo');
  }

  _createClass(PageChangeAnime, [{
    key: "out",
    value: function out() {
      var lastElm = document.querySelector('body').lastElementChild;
      if (lastElm.nodeName == 'DIV' || lastElm.nodeName == 'div') lastElm.parentNode.removeChild(lastElm);
      this.outPC();
    }
  }, {
    key: "in",
    ...
    value: function outPC() {
      ...
      if (window.pageId != 'index') {
        // ページタイトル
        var chars = document.querySelector('.l-kv__read').querySelector('.title').querySelectorAll('.delay-elem');
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(chars, {
          transitionDuration: '0.4s',
          transform: 'translate3d(-30px,-12px,0) rotateY(-60deg)',
          opacity: '0'
        });
      } else {
        var kvRead = document.querySelector('.l-index-kv__read');

        var _chars = kvRead.querySelector('.title').querySelectorAll('.c');

        var copyEn = kvRead.querySelector('.copy-en');
        var btn = kvRead.querySelector('.btn');
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(_chars, {
          transform: 'translate3d(-60px,-80px,10px) rotate3d(1,0,0,60deg) scale(0.8)',
          opacity: '0'
        });
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(copyEn, {
          transform: 'translate3d(-10px,-40px,0)',
          opacity: '0',
          transitionDelay: '0.1s'
        });
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(btn, {
          transform: 'translate3d(-10px,-40px,0)',
          opacity: '0',
      ...
      var outElms = document.querySelectorAll('.delay-elem-out');
      Array.from(outElms, function (outElm) {
        outElm.style.transitionTimingFunction = 'cubic-bezier(0.3,0.4,0.1,1)';
      });
      if (outElms) gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(outElms, {
      ...
      if (window.isPC) {
        // header
        this.logo.style = "";
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to([this.gnav, this.logo], 0.8, {
          opacity: 0,
          ease: Power3.easeOut,
          onComplete: function onComplete() {
            gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(_this.gnavList, {
              transform: 'translate3d(12px,-8px,-10px)',
              transitionDuration: '0s',
              transitionTimingFunction: 'cubic-bezier(0.3,0.4,0.1,1)',
              opacity: '0'
            });
          }
        }); // headerFixed

        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to([this.headerFixedGnav, this.headerFixedBg, this.headerFixedLogo], 0.8, {
          opacity: 0,
          ease: Power3.easeOut,
          onComplete: function onComplete() {
            _this.headerFixed.classList.add('hidden');

            gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(_this.headerFixedGnavList, {
              transform: 'translate3d(12px,-8px,-10px)',
              transitionDuration: '0s',
              transitionTimingFunction: 'cubic-bezier(0.3,0.4,0.1,1)',
              opacity: '0'
            });
            gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set([_this.headerFixedLogo, _this.headerFixedBg], {
              transitionDuration: '0s',
              transitionTimingFunction: 'cubic-bezier(0.3,0.4,0.1,1)',
              opacity: '1'
            });
      ...
      gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(this.page, 0.6, {
        opacity: 0,
        ease: Power2.easeIn
      });
    }
    ...
    value: function inPC() {
      ...
      if (window.finishedFirstLoad == undefined) {
        ...
        var load = document.querySelector('.l-bg'); // Cara - l-load改成l-bg //20230822
		
        // Cara 取消 //20230822
        // var loader = load.querySelector('.load__loader');
        // loader.style.transform = 'scale(0)';
          
        var bg1 = document.querySelector('.bg1');
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set([bg1], {
          transform: window.isPC ? 'skewX(30deg) translateX(-150vw)' : 'skewX(15deg) translateX(-150vw)'
        });
        // setTimeout(function () {
        //   load.style.display = 'none';
        // }, 1800);
        fluidAnimation();
        if (window.pageId == 'index') setTimeout(function () {
          _this2.kvAnimation();
        }, 1800); // },500)

        if (window.isPC) {
          setTimeout(function () {
            gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(_this2.gnav, 0, {
              opacity: 1,
              ease: Power3.easeOut,
              delay: 0,
              onComplete: function onComplete() {
                gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set([_this2.gnavList, _this2.logo], {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(_this2.headerFixedGnav, 0, {
              opacity: 1,
              ease: Power3.easeOut,
              delay: 0,
              onComplete: function onComplete() {
                gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(_this2.headerFixedGnavList, {
                  transform: 'translate3d(0px,0px,0px)',
                  transitionDuration: '0.8s',
                  transitionTimingFunction: 'cubic-bezier(0.3,0.4,0.1,1)',
                  opacity: '1'
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(this.page, 0, {
          opacity: "1"
        });
        if (this.controller != null) this.controller.page();
        if (window.pageId == 'index') this.kvAnimation();

        if (window.isPC) {
          // header
          gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(this.gnav, 0, {
            opacity: 1,
            ease: Power3.easeOut,
            delay: 0.6,
            onComplete: function onComplete() {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].to(this.headerFixedGnav, 0, {
            opacity: 1,
            ease: Power3.easeOut,
            delay: 0.6,
            onComplete: function onComplete() {
      ...
      // setTimeout(function () {
      //   _this2.headerFixed.classList.remove('hidden');
      // }, 100);
    }
  }, {
    key: "kvAnimation",
    value: function kvAnimation() {
      var kvRead = document.querySelector('.l-index-kv__read');
      if (kvRead == null) return;
      var chars = kvRead.querySelector('.title').querySelectorAll('.c');
      var copyEn = kvRead.querySelector('.copy-en');
      var btn = kvRead.querySelector('.btn-area'); //
...
/* harmony import */ var _UIDelayStepper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UIDelayStepper.js */ "./src/js/components/UIDelayStepper.js");
  ...
  _createClass(Pjax, [{
    ...
    value: function set(elm) {
      var pjax = new pjax__WEBPACK_IMPORTED_MODULE_0___default.a({
        elements: elm == null ? ['.js-pjax', 'a.page-numbers'] : elm,
        ...
        switches: _defineProperty({
          '.l-page': pjax__WEBPACK_IMPORTED_MODULE_0___default.a.switches.sideBySide
    ...
    value: function on() {
      ...
      function completeDom() {
        // DOMが変更された際の処理
        var pageId = document.querySelector('.l-page').getAttribute('data-page-id');
        window.pageId = pageId; // Preload.js側でフェードインのアニメーションを実施する
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function (controller, callbackFileComplete) {
  ...
  var imgArray = [];
  setImgArray(); // console.log(imgArray.length)
  ...
  function setImgArray() {
    if (imgs.length > 0 || bgImgs.length > 0 || bgImgsPC.length > 0 || bgImgsSP.length > 0) {
      ...
      if (window.isPC) {
        for (var _i2 = 0; _i2 < imgsPC.length; _i2++) {
          imgArray.push(imgsPC[_i2].src);
          count++;
        }

        for (var _i3 = 0; _i3 < bgImgsPC.length; _i3++) {
          var _elm = bgImgsPC[_i3];
        ...
        for (var _i4 = 0; _i4 < imgsSP.length; _i4++) {
          imgArray.push(imgsSP[_i4].src);
          count++;
        }

        for (var _i5 = 0; _i5 < bgImgsSP.length; _i5++) {
          var _elm2 = bgImgsSP[_i5];
  ...
  function loadImg() {
    ...
    for (var i = 0; i < length; i++) {
      ...
      img.onload = function () {
        ...
        handleFileComplete(progress); // console.log(progress)
...
/***/ "./src/js/components/PreloadAll.js":
/*!*****************************************!*\
  !*** ./src/js/components/PreloadAll.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function (controller) {
	// cara 取消
  // var imgArrayPC = [// top
  // '/wp-content/themes/MatchingAgent/assets/images/pc/top/img_about1.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/top/img_about2.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/top/img_about3.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/top/img_product1.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/top/img_product2.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/top/img_product3.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/top/img_recruit1.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/top/img_product_iphone.png', // about
  // '/wp-content/themes/MatchingAgent/assets/images/pc/about/bg_mission1.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/about/bg_mission2.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/about/bg_mission3.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/about/img_calture1.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/about/img_calture2.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/about/img_calture3.jpg', '/wp-content/themes/MatchingAgent/assets/images/pc/about/img_calture4.jpg', // company
  // '/wp-content/themes/MatchingAgent/assets/images/pc/company/img_ceo.jpg', // recruit
  // '/wp-content/themes/MatchingAgent/assets/images/pc/recruit/img_recruit.jpg'];
  // loadImg(imgArrayPC);

  function loadImg(imgArray) {
    var length = imgArray.length,
        count = 0,
        progress; // console.log('preloadAll:' + length)
  ...
  function handleComplete() {
    // console.log('preloadAll:Complete')
    controller.vertialScroll.resize();
  }

  function handleFileComplete(progress) {// console.log('preloadAll:' + progress)
  }
});

/***/ }),

/***/ "./src/js/components/ReplaceImg.js":
/*!*****************************************!*\
  !*** ./src/js/components/ReplaceImg.js ***!
  \*****************************************/
/*! exports provided: default */
...
/***/ "./src/js/components/ScrollInviewItem.js":
/*!***********************************************!*\
  !*** ./src/js/components/ScrollInviewItem.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ScrollInviewItem; });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ScrollInviewItem =
/*#__PURE__*/
function () {
  function ScrollInviewItem(elm) {
    _classCallCheck(this, ScrollInviewItem);

    var offsetTop = elm.getAttribute('data-offset-top'),
        // オフセット(TOP)
    offsetBottom = elm.getAttribute('data-offset-bottom'),
        // オフセット(BOTTOM)
    offsetTopUnit = elm.getAttribute('data-offset-top-unit'),
        // 単位（px or  %）
    ...
    this.inviewStyle = elm.dataset ? elm.dataset.inviewStyle : null;
    this.top = 0;
    this.bottom = 0;
    this.elm = elm;
    this.offsetTop = offsetTop ? offsetTop : 0.9;
    this.offsetBottom = offsetBottom ? offsetBottom : -0.1;
    this.isPXoffsetTop = offsetTopUnit == 'px';
    this.isPXoffsetBottom = offsetBottomUnit == 'px';
  }

  _createClass(ScrollInviewItem, [{
    key: "init",
    ...
    key: "show",
    value: function show(scrollTop, innerHeight) {
      var _this = this;
      ...
      if (top > this.top && bottom < this.bottom) {
        if (this.elm.classList.contains('is-shown')) return;

        switch (this.inviewStyle) {
          case 'section-frame':
          ...
          case 'section-title':
            setTimeout(function () {
              _this.elm.classList.add('is-shown');
            }, 100);
            break;
          ...
          default:
            ...
            var _loop = function _loop() {
              var elmchild = _this.elmChildren[i]; // elmchild.classList.add('is-shown');
              ...
              switch (inviewStyle) {
                ...
                default:
                  elmchild.classList.add('is-shown');
              }
            };
...
/***/ "./src/js/components/ScrollItems.js":
/*!******************************************!*\
  !*** ./src/js/components/ScrollItems.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ScrollItems; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ScrollParallaxItem = __webpack_require__(/*! ./ScrollParallaxItem */ "./src/js/components/ScrollParallaxItem.js").default;

var ScrollInviewItem = __webpack_require__(/*! ./ScrollInviewItem */ "./src/js/components/ScrollInviewItem.js").default;
...
function () {
  ...
  _createClass(ScrollItems, [{
    key: "init",
    value: function init() {
      var elmInviewItems = document.querySelectorAll('.js-inview-item'); // const elmParallaxItems = document.querySelectorAll('.js-parallax-item');

      this.inviewItems = [];
      this.parallaxItems = []; // inviewのスタイル初期化
      // let sectionFrameElms = document.querySelectorAll('[data-inview-style="section-frame"]')
      // if(sectionFrameElms != null) TweenMax.set(sectionFrameElms, {transform: 'translate3d(0,30px,0)', opacity: '0'})
      // let showUpElms = document.querySelectorAll('[data-inview-style="show-up"]')
      // if(showUpElms != null) TweenMax.set(showUpElms, {transform: 'translate3d(0,30px,0)', opacity: '0'})
    ...
    value: function scroll() {
      ...
      for (var i = 0; i < this.inviewItems.length; i++) {
        this.inviewItems[i].show(this.scrollTop, this.innerHeight); //   this.scrollTop + window.innerHeight * 0.9,
        //   this.scrollTop + window.innerHeight * 0.1
        // );
      }
    }
  }, {
    ...
    key: "render",
    value: function render() {// for (var i = 0; i < this.parallaxItems.length; i++) {
...
/***/ "./src/js/components/ScrollParallaxItem.js":
/*!*************************************************!*\
  !*** ./src/js/components/ScrollParallaxItem.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ScrollParallaxItem; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ScrollParallaxItem =
/*#__PURE__*/
function () {
  function ScrollParallaxItem(elm, scrollItems, targetSpeed, targetPercentage) {
    _classCallCheck(this, ScrollParallaxItem);

    var offset = elm.getAttribute('data-offset'),
        // オフセット
    speedX = elm.getAttribute('data-speed-x'),
        // エフェクトスピード(X軸)
    speedY = elm.getAttribute('data-speed-Y'),
        // エフェクトスピード(Y軸)
    percentage = elm.getAttribute('data-percentage'),
        horizontal = elm.getAttribute('data-horizontal'); //水平方向に移動する場合は、data-horizontal = "1"

    this.scrollItems = scrollItems;
    this.elm = elm;
    this.targetSpeed = targetSpeed ? targetSpeed : 0.02;
    this.targetPercentage = targetPercentage ? targetPercentage : 0.1;
    this.offset = offset ? offset : 0;
    this.speedX = speedX ? speedX : 1;
    this.speedY = speedY ? speedY : 1;
  ...
  _createClass(ScrollParallaxItem, [{
    key: "init",
    value: function init() {
      this.scroll();
    }
    ...
    key: "scroll",
    value: function scroll() {
      this.top += (this.scrollItems.scrollTop * Number(this.targetSpeed) * Number(this.speedY) - this.top) * this.targetPercentage;
      this.left += (this.scrollItems.scrollTop * Number(this.targetSpeed) * Number(this.speedX) - this.left) * this.targetPercentage;
      var targetOffsetTop = parseInt(this.percentage) - this.top - parseInt(this.offset);
      var offsetY = Math.round(targetOffsetTop * -100) / 100;
      var offsetX = 0;

      if (this.horizontal) {
        var targetOffsetLeft = parseInt(this.percentage) - this.left - parseInt(this.offset);
        offsetX = Math.round(targetOffsetLeft * -100) / 100;
      }

      this.elm.style.transform = 'translate3d(' + offsetX + 'px ,' + offsetY + 'px ,' + 0 + ')';
    }
  }, {
    key: "render",
    value: function render() {
...
/***/ "./src/js/components/UIDelayStepper.js":
/*!*********************************************!*\
  !*** ./src/js/components/UIDelayStepper.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UIDelayStepper; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/*#__PURE__*/
function () {
  function UIDelayStepper() {
    _classCallCheck(this, UIDelayStepper);

    this.parent = [].slice.call(document.querySelectorAll('[data-delay-step]'));
  }

  _createClass(UIDelayStepper, [{
    key: "run",
    value: function run() {
      var _this = this;

      this.parent.forEach(function (target, index) {
        _this._addDelay(target);
      });
    }
    /**
     *
    ...
    key: "_addDelay",
    value: function _addDelay(parent) {
      var $targets = [].slice.call(parent.querySelectorAll('.delay-elem')),
          len = $targets.length,
          ...
          delayInit = parent.getAttribute('data-delay-init') || 0,
          randomStep = [],
          children = [];
      if (len === 0) return;
      $targets.forEach(function ($target, index) {
        if (null !== $target.getAttribute('data-delay-step')) {
          [].slice.call($target.querySelectorAll('.delay-elem')).forEach(function (elem) {
            children.push(elem);
          });
        } else if ($target.querySelectorAll('[data-delay-step]')) {
          [].slice.call($target.querySelectorAll('[data-delay-step]')).forEach(function (parent) {
            [].slice.call(parent.querySelectorAll('.delay-elem')).forEach(function (elem) {
              children.push(elem);
            });
          });
        }
    ...
    key: "_noneOverWrapRandom",
    value: function _noneOverWrapRandom(count) {
      var random = [],
    ...
    key: "destroy",
    value: function destroy() {// this.target.css( {
      //     'transition-delay' : ''
      // } );
    }
  }]);

  return UIDelayStepper;
}();
...
/***/ "./src/js/components/UIDelayStepper2.js":
/*!**********************************************!*\
  !*** ./src/js/components/UIDelayStepper2.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function (parent) {
  var elm = parent == null ? '[data-delay-step-out]' : parent;
  var parents = [].slice.call(document.querySelectorAll(elm));
  parents.forEach(function (target, index) {
    var delayStepOut = Number(target.dataset.delayStepOut);
    var elms = target.querySelectorAll('.delay-elem-out');

    for (var i = 0; i < elms.length; i++) {
      elms[i].style.transitionDelay = delayStepOut * i + 's';
    }
  }); // Array.from(parents, parent => {
  //
  //   elms.
  //
  // })
}); // export default class UIDelayStepper2 {
//     constructor() {
//       this.parent = [].slice.call( document.querySelectorAll( '[data-delay-step-out]' ) );
//     }
//
//     run() {
...
//      */
//     _addDelay( parent ) {
//         let $targets = [].slice.call( parent.querySelectorAll('.delay-elem-out')),
//             len = $targets.length,
//             step = parent.getAttribute( 'data-delay-step' ),
//             mode = parent.getAttribute( 'data-delay-mode' ) || 'step',
//             delay = parent.getAttribute( 'data-delay-delay' ) || 0,
...
//         $targets.forEach( function( $target, index ) {
//             if ( null !== $target.getAttribute( 'data-delay-step' ) ) {
//                 [].slice.call( $target.querySelectorAll( '.delay-elem-out' ) ).forEach( elem => {
//                     children.push( elem );
//                 } );
//             } else if ( $target.querySelectorAll( '[data-delay-step]' ) ) {
//                 [].slice.call( $target.querySelectorAll( '[data-delay-step]' ) ).forEach( parent => {
//                     [].slice.call( parent.querySelectorAll( '.delay-elem-out' ) ).forEach( elem => {
//                         children.push( elem );
//                     } );
//                 } );
//             }
...
/***/ "./src/js/components/UserAgentChecker.js":
/*!***********************************************!*\
  !*** ./src/js/components/UserAgentChecker.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var isSmartphone = __webpack_require__(/*! ./utils/isSmartphone */ "./src/js/components/utils/isSmartphone.js"),
    OPTIONS = {
  userAgent: true,
  displayWidth: true,
  displayWidthSP: 768
...
/***/ "./src/js/components/VertialScroll.js":
/*!********************************************!*\
  !*** ./src/js/components/VertialScroll.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VertialScroll; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ScrollItems = __webpack_require__(/*! ./ScrollItems */ "./src/js/components/ScrollItems.js").default;

// cara 取消
// var Header = __webpack_require__(/*! ./Header */ "./src/js/components/Header.js").default;
...
/*#__PURE__*/
function () {
  function VertialScroll(options) {
    _classCallCheck(this, VertialScroll);

    this.scrollItems = new ScrollItems();
    // this.header = new Header(); // this.Targets = [];

    this.TargetsLength = 0;
    this.wrapper = '';
    this.windowHeight = 0;
    this.wapperOffset = 0;
    this.scrollTop = document.documentElement.scrollTop || document.body.scrollTop; // this.isOnVS = false
  ...
  _createClass(VertialScroll, [{
    ...
    value: function init(options) {
      ...
      this.apply(); // other action

      this.scrollItems.init(); // ページ表示時に一回だけスクロールイベントを行う
    ...
    key: "apply",
    value: function apply() {
      if (this.isOnVS) this.wrapperInit();
    }
  }, {
    key: "wrapperInit",
    ...
    key: "vsScroll",
    value: function vsScroll() {
      if (this.isScrolling) {
        this.wrapperSpeed = 0.9;
      } else {
        this.wrapperSpeed = 1.0;
      }
    ...
    value: function wrapperUpdate() {
      this.wapperOffset += (this.scrollTop - this.wapperOffset) * this.wrapperSpeed;
    ...
    value: function attachEvent() {
      ...
      window.addEventListener('scroll', function (event) {
        ...
        _this2.isScrolling = true; // スクロールを停止して500ms後に終了とする
      ...
      window.addEventListener('resize', function () {
        if (!_this2.isResize) {
          cancelAnimationFrame(_this2.resizeId);
          cancelAnimationFrame(_this2.scrollId);
          _this2.isResize = true;
          setTimeout(function () {
            _this2.isResize = false;
            _this2.resizeId = requestAnimationFrame(_this2.resize.bind(_this2));
            _this2.scrollId = requestAnimationFrame(_this2.render.bind(_this2));
          }, 200);
        }
      }); // window.addEventListener('mousewheel', event => {
      //   console.log(event.deltaY)
      //   if(event.deltaY != 0) {
      //     this.settings.wrapperSpeed = 0.44
      //   } else {
      //     console.log(event.deltaY)
      //     this.settings.wrapperSpeed = 1.0
      //   }
    ...
    value: function render() {
      this.vsScroll();
      this.scrollId = requestAnimationFrame(this.render.bind(this)); // other action
      // this.scrollItems.render();
    }
  }]);

  return VertialScroll;
}();
...
/***/ "./src/js/components/VueCommon.js":
/*!****************************************!*\
  !*** ./src/js/components/VueCommon.js ***!
  \****************************************/
/*! exports provided: default */
...
vue__WEBPACK_IMPORTED_MODULE_1__["default"].config.devtools = false; // let UIDelayStepper2 = require('./UIDelayStepper2.js').default
  ...
  function vCalture() {
    new vue__WEBPACK_IMPORTED_MODULE_1__["default"]({
      ...
      data: {
        items: [],
        selectId: 'all',
        caltureNaviHeight: null
      },
      methods: {
        showText: function showText(e) {
          var elmClass = e.currentTarget.classList;

          if (elmClass.contains('show')) {
            elmClass.add('hide');
            setTimeout(function () {
              elmClass.remove('show');
              elmClass.remove('hide');
            }, 800);
          } else {
            elmClass.add('show');
          }
        ...
        showCategory: function showCategory(category) {
          if (this.selectId == 'all') return true;
          if (this.selectId == category) return true;
          return false;
        },
        ...
        leaveItem: function leaveItem() {
          var delayStepOut = 60;
          var parent = document.querySelector('.s-calture-list');
          parent.style.minHeight = '800px';
          var elms = parent.querySelectorAll('.item');

          for (var i = 0; i < elms.length && i < 6; i++) {
            elms[i].style.transitionDelay = delayStepOut * i + 'ms';
          }

          gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(elms, {
            transform: 'translate3d(0,30px,0)',
            opacity: '0'
          });
          gsap__WEBPACK_IMPORTED_MODULE_0__["TweenMax"].set(parent, {
            opacity: '0',
            transitionDelay: '0.1s',
            transitionDuration: '0.4s'
          });
        ...
        naviOpenClose: function naviOpenClose() {
          var elmCaltureNavi = document.querySelector('.calture-navi');

          if (elmCaltureNavi.classList.contains('close')) {
            elmCaltureNavi.classList.remove('close');
            elmCaltureNavi.style.height = this.caltureNaviHeight + 'px';
          } else {
            elmCaltureNavi.classList.add('close');
            elmCaltureNavi.style.height = 60 + 'px';
          }
        }
      },
      created: function created() {
        if (window.isSP) {
          var navi = document.querySelector('.calture-navi');
          this.caltureNaviHeight = navi.clientHeight;
...
/***/ "./src/js/components/common/Hover.js":
/*!*******************************************!*\
  !*** ./src/js/components/common/Hover.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  // case pc
  if (window.isPC) onHover(); // case SP
...
/***/ "./src/js/components/common/LimitScrollOff.js":
/*!****************************************************!*\
  !*** ./src/js/components/common/LimitScrollOff.js ***!
  \****************************************************/
/*! exports provided: default */
...
/***/ "./src/js/components/common/Polyfills.js":
/*!***********************************************!*\
  !*** ./src/js/components/common/Polyfills.js ***!
  \***********************************************/
/*! exports provided: default */
...
/***/ "./src/js/components/common/SmoothScroll.js":
/*!**************************************************!*\
  !*** ./src/js/components/common/SmoothScroll.js ***!
  \**************************************************/
/*! exports provided: default */
...
/***/ "./src/js/components/utils/debounce.js":
/*!*********************************************!*\
  !*** ./src/js/components/utils/debounce.js ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/js/components/utils/isEdge.js":
/*!*******************************************!*\
  !*** ./src/js/components/utils/isEdge.js ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./src/js/components/utils/isIE.js":
/*!*****************************************!*\
  !*** ./src/js/components/utils/isIE.js ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./src/js/components/utils/isSmartphone.js":
/*!*************************************************!*\
  !*** ./src/js/components/utils/isSmartphone.js ***!
  \*************************************************/
/*! no static exports found */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  new _components_Map__WEBPACK_IMPORTED_MODULE_0__["default"]();
});

/***/ }),

/***/ "./src/js/init/Contact.js":
/*!********************************!*\
  !*** ./src/js/init/Contact.js ***!
  \********************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function (controller) {
  document.addEventListener('wpcf7mailsent', function (event) {
    ...
    var pjax = controller.pjax.set('form');
    pjax.loadUrl("/thanks/");
  }, false);
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_Controller_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/Controller.js */ "./src/js/components/Controller.js");
 // import {TweenMax, Power2} from "gsap";


document.addEventListener('DOMContentLoaded', function () {
  new _components_Controller_js__WEBPACK_IMPORTED_MODULE_0__["default"]().init();
}, false);
document.addEventListener('touchstart', function (event) {
  if (event.touches.length > 1) {
    event.preventDefault();
  }
}, true); // class FpsCalculator {
// 		constructor() {
