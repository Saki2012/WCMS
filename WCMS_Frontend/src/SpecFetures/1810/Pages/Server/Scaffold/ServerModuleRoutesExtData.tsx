...
const extendServerModuleRoutes = (modules: IModuleMeta[]): IModuleMeta[] => {
    ...
    const prog: IProgMeta[] = [
        {
            ProgId: PGID.SpecResearch, Title: "研究計畫", DefaultActionCode: "List", IconClassName: "fas fa-search",
            Actions: [
                {
                ...
                {
                    ActionCode: PGID.SpecCategory, Title: "研究計畫類別", RoutePath: `${PGID.SpecCategory}/:internalId?`,
        ...
        {
            ProgId: PGID.SpecUSR, Title: "計畫成果版型", DefaultActionCode: "List", IconClassName: "fas fa-university",
            Actions: [
                {
                ...
                {
                    ActionCode: PGID.SpecCategory, Title: "計畫成果類別", RoutePath: `${PGID.SpecCategory}/:internalId?`,
