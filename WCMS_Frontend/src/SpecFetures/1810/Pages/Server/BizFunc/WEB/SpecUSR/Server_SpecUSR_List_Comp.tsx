...
export const Server_SpecUSR_List_Comp = (prop: { title: string; theme: IBETheme; lang: Lang; }) =>
{
    ...
    return <Server_ListGridTemplate_Comp Title={prop.title} Theme={prop.theme} template={template} buildSearchBarNode={SpecUSRSearchBarSection} />;
};
// #endregion

// #region Section
/** 渲染計畫成果列表搜尋列 */
const SpecUSRSearchBarSection = (props: ServerListGridSearchRenderProps) =>
{
    return (
...
// #region Protected
/** 渲染標籤欄位內容 */
const buildSpecUSRTagContentNode = (ids: string | null | undefined, map: Record<string, string>): ReactNode =>
{
...
const specUSRListRenderers: SpecUSRListRenderers = {
    buildTagContentNode: buildSpecUSRTagContentNode,
};
// #endregion
