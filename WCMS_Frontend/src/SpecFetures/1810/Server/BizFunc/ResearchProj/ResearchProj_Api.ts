...
abstract class IAnnouncementProvider extends IDataProvider<SpecResearchSet> { }
class MockProvider extends IAnnouncementProvider {
    ...
    protected async doFetchList(condition: QueryListCondition): Promise<ApiResponse<SpecResearchSet[]>> {
        throw new Error('Method not implemented.');
    }
...
const SpecResearch_Provider = (): IAnnouncementProvider => IApiProvider<IAnnouncementProvider>(APIProvider, MockProvider);
export default SpecResearch_Provider