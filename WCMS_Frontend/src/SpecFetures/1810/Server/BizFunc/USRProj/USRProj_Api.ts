...
abstract class IAnnouncementProvider extends IDataProvider<SpecUSRSet>
{}
...
const SpecUSR_Provider = (): IAnnouncementProvider => IApiProvider<IAnnouncementProvider>(APIProvider, MockProvider);
export default SpecUSR_Provider;
