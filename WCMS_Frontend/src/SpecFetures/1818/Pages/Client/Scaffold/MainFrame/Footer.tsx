                    ...
                    <div className="widgets-box">
                        <div className="row">
                                        ...
                                        <div className="footer-widget info-widget">
                                            ...
                                            <div className="widget-title-content">
                                                <div className="TitleDivBox">
                                                    <span className="widget-title">聯絡我們</span>
                                                </div>
                                            </div>
                            ...
                            <div className="col-sm-6 col-12">
                                <div className="row">
                                    <div className="col-12 mb-md-0 mb-3">
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3641.3725318706947!2d120.675326!3d24.123552000000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x34693cfcecffe9d9%3A0xe28afadc0dad203a!2sNational%20Chung%20Hsing%20University!5e0!3m2!1sen!2stw!4v1760948502719!5m2!1sen!2stw"
                        ...
                        <div className="row">
                            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div className="info_contact">
                                    <div className="dbox">
                                        <p>Copyright © 2025. 國立中興大學 全球事務研究跨洲碩士學位學程 All rights reserved.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
