							...
							<div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mt-lg-5 pt-lg-5 mt-0 pt-4">
								...
								<div className="about-left">
									<p className="about-txt">
										跨洲學程按學期集結於德國、臺灣及墨西哥三地授課，由各校優秀師資以全英語教授亞洲、歐洲及美洲的社會經濟概況，因地制宜探討臺海兩岸關係、歐洲聯盟及北美自由貿易協議等重要議題，不僅增長經營管理知識，瞭解全球競爭環境及主要經濟體的變化，亦有利擴大學生國際視野與經驗。

										於第四學期，學生得選擇在任一地區以英語撰寫碩士論文並進行口試，同時，學生可逕依意願申請企業實習，期透過理論與實務結合，與企業產生聯結、良性互動。學生完成學業且符合各校畢業條件後，由三校各頒碩士學位證書及修業證明。

										藉由國立中興大學「全球事務研究跨洲碩士學位學程」嚴謹的課程規劃，學生不僅得建立跨洲人際社交網絡，亦具備全球就業市場所需之競爭力。114學年度預計與世界排名前300大名校華沙大學合作(原本兩所學校將不再合作)，學生於中興及華沙各修讀一學年，後以英文撰寫畢業論文及口試，通過兩校畢業條件後即可獲取雙學位。
									</p>
