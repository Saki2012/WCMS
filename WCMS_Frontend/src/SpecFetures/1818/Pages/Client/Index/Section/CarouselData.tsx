...
const toOkEnv = <T,>(data: T): ApiResponse<T> => { return { IsSuccess: true, SysMessage: [], Data: data }; };
const toInitial = <TArgs, TData>(args: TArgs, data: TData): ApiLoaderData<TArgs, TData> => { return { args, apiRes: toOkEnv(data) }; };
            ...
            <div className="carousel slide d-flex justify-content-end" id="B5_default_carousel">
              ...
              <div className="control-box">
                <div className="control-start">
                  <a aria-label="播放輪播" aria-pressed="false" href="#B5_default_carousel" id="cycleCarousel" tabIndex={0} title="播放" type="button">
                    <span className="control-start-icon" />
                    <span className="sr-only">播放</span>
                  </a>
                </div>
                <div className="control-pause">
                  <a aria-label="暫停輪播" aria-pressed="true" href="#B5_default_carousel" id="pauseCarousel" tabIndex={0} title="暫停" type="button">
