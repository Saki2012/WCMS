  ...
  Owl.Workers = [
    ...
    },
    {
      ...
      run: function () {
        ...
        // 重要 使用鍵盤 tab 鍵時，不讓它們被 focus 到 [ JESS 20250901 ]
        while (repeat > 0) {
          // Switch to only using appended clones
          clones.push(this.normalize(clones.length / 2, true));
          append =
            append +
            items[clones[clones.length - 1]][0].outerHTML.replace(
              /tabindex="0"/g,
              'tabindex="-1"'
            );
          clones.push(
...
(function ($, window, document, undefined) {
  ...
  Navigation.Defaults = {
    ...
    navText: [
      ...
      '<span aria-label="' +
        "Previous" +
        '" title="上一張"><span class="d-none">上一張</span></span>',
      '<span aria-label="' +
        "Next" +
        '" title="下一張"><span class="d-none">下一張</span></span>',
    ],
    navSpeed: false,
    navElement: 'button type="button" role="presentation" tabindex="0"',
    navContainer: false,
