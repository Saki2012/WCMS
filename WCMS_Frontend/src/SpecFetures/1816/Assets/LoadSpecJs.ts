import "./Client/Content/jquery-3.7.1/jquery-3.7.1.min.js";
window.$ = window.jQuery;
import "./Client/Content/jquery-3.7.1/bootstrap.js"; // 考慮移除
import "./Client/Content/bootstrap-5.3.3/popper/popper-core-v2.10.2.min.js"; // 考慮移除
