...
import { useScheduleRuleListFetchData, type ScheduleRuleListRawData } from "./Server_ScheduleRule_List_Hook";
...
export const Server_ScheduleRule_List_Comp = (prop: { title: string; theme: IBETheme }) => {
    ...
    const searchCompProp: SearchBarProps = {title: "規則搜尋",subTitle: "搜尋學年度 ...",settingTitle: "搜尋設定",onSubmit: setKw,onReset: () => setKw(""),};
