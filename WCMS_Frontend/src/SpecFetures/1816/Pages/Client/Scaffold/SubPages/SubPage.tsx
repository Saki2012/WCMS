...
import { Banner_Comp } from "./Banner_Comp";
import { BreadCrumb_Comp } from "./BreadCrumb_Comp";
import { Toolbar_Comp } from "./Toolbar_Comp";
import { SubMenu_Comp } from "./SubMenu_Comp";
import { ThirdMenu_Comp } from "./ThirdMenu_Comp";
...
export const SubPage = (props: { style: IFETheme; lang: Lang; site: INormSite; node: INormNode; backHref?: string; }) => {
    return (<>
        {/* <Banner_Comp /> */}
        <AccessKeySection />
