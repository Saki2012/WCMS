						...
						>
							...
							<div className="control-singlebox">
								<div className="control-toggle">
									<a
										...
										type="button"
										onClick={(event) => { preventDefaultClick(event, handleToggle); }}
										onKeyDown={(event) => { handleActionKeyDown(event, handleToggle); }}
									>
								...
								{Array.from({ length: indicatorCount }).map((_, i) => {
									...
									return (
										<a
											...
											tabIndex={0}
											title="上一張"
											onClick={(event) => { preventDefaultClick(event, () => { handleIndicator(i); }); }}
											onKeyDown={(event) => { handleActionKeyDown(event, () => { handleIndicator(i); }); }}
										>
											<button
							...
							<div className="carousel_btn-icon-prev">
								<a
									...
									title="上一張"
									type="button"
									onClick={(event) => { preventDefaultClick(event, handlePrev); }}
									onKeyDown={(event) => { handleActionKeyDown(event, handlePrev); }}
								>
							...
							<div className="carousel_btn-icon-next">
								<a
									...
									title="下一張"
									type="button"
									onClick={(event) => { preventDefaultClick(event, handleNext); }}
									onKeyDown={(event) => { handleActionKeyDown(event, handleNext); }}
								>
