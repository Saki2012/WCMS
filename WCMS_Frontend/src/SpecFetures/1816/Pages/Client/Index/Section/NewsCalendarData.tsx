...
export const NewsCalendarData = (props: { lang: Lang; initialOpenTime: CurrentOpenTime | null }) =>
{
  ...
  const initial = useMemo(() => { return buildCurrentOpenTimeInitial(props.initialOpenTime); }, [props.initialOpenTime]);
                  ...
                  <div className="Date_wrapbox d-flex">
                    <div className="DateTitleBox d-flex">
                      ...
                      <div className="open_btn_black">
                        <LangLink className="Open_btn" to={"/services/services-loan/services-loan-01"} tabIndex={0} target="_self" title={uiText.openDetailTitle}>
