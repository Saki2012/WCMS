            ...
            <div className="background_area">
                ...
                <section className="container-customize4">
                    <div className="row">
                        ...
                        <NewsData
                            lang={props.lang}
                            listParam01={loaderData.args.newsListParam01}
                            listParam02={loaderData.args.newsListParam02}
                            listParam03={loaderData.args.newsListParam03}
                            listParam04={loaderData.args.newsListParam04}
                            cateParam={loaderData.args.newsCateParam}
                            tagParam={loaderData.args.newsTagParam}
                            initialList01={rawData.newsList01}
                            initialList02={rawData.newsList02}
                            initialList03={rawData.newsList03}
                            initialList04={rawData.newsList04}
