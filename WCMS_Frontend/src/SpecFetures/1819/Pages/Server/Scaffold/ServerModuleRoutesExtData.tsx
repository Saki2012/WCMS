...
const extendServerModuleRoutes = (modules: IModuleMeta[]): IModuleMeta[] =>
{
    ...
    web.Progs.push({
        ...
        Actions: [{
            ...
            elementFactory: (ctx) => <Server_SpecJournal_List_Comp title="預刊本列表" theme={ctx.theme} lang={ctx.lang} mode="preprint" />,
        }, {
            ActionCode: "Preprint/Form",
            Title: "新增預刊本",
            RoutePath: "Preprint/Form/:internalId?",
            elementFactory: (ctx) => <Server_SpecJournal_Form_Comp theme={ctx.theme} lang={ctx.lang} mode="preprint" />,
        }, {
            ActionCode: "Tag",
            Title: "期刊類型",
        ...
        Actions: [{
            ...
            Title: "期刊列表",
            RoutePath: "List",
            elementFactory: (ctx) => <Server_SpecJournal_List_Comp title="期刊列表" theme={ctx.theme} lang={ctx.lang} mode="journal" />,
        }, {
            ActionCode: "Form",
            Title: "新增期刊",
            RoutePath: "Form/:internalId?",
            elementFactory: (ctx) => <Server_SpecJournal_Form_Comp theme={ctx.theme} lang={ctx.lang} mode="journal" />,
        }, {
            ActionCode: "Tag",
            Title: "期刊類型",
