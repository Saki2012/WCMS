...
export const RelatedLinksSection = (props: RelatedLinksSectionProps) =>
{
    ...
    const initial = useMemo(() => toListInitial(props.relatedLinksParam, props.initialData.relatedLinksList ?? []), [props.relatedLinksParam, props.initialData.relatedLinksList]);
                            ...
                            <div className="col-12">
                                            ...
                                            return (
                                                <div key={id} className="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6 + mb-4">
                                                    <figure className="figure_Box">
                                                        <LangNavLink to={url} className="card_image_link" title={title} target={tar}>
                                ...
                                <div className="btn-w100-wrapper justify-content-center">
                                    <div className="customize_btn">
                                        <LangNavLink to={"/About/About-others/Links"} className="Btn_a" role="button" title="VIEW MORE">
