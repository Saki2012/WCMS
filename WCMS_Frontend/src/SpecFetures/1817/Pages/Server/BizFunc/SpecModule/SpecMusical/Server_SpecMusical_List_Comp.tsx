...
import { AccountFields, SpecMusicalModelFields, SpecMusicalSetFields } from "@/types/SchemaFields";
...
export const Server_SpecMusical_List_Comp = (prop: { title: string; theme: IBETheme; lang: Lang }) => {
    ...
    const useData = useSpecMusicalList(provider, prop.lang, kw);
...
const useSpecMusicalList = (provider: IDataProvider<SpecMusicalSet>, lang: Lang, query: string) => {
    let condition: string = ``;
    if (!!query) condition = LibMerge(" And ", false, condition, `${SpecMusicalModelFields.MusicalName} Like ${query}`)
    return useFetchGridListData<SpecMusicalSet>({
        ...
        visibleKeys: [
            ...
            // [SpecMusicalSetFields.SpecMusical, SpecMusicalModelFields.categ],
        ...
        buildQueryCondition: (page) => ({
            ...
            Condition: condition,
            OrderBy: [
                { Col: SpecMusicalModelFields.CreateTime, Desc: true },
            ],
            PageNumber: page,
            PageSize: 10,
        }),
