...
export const ExhibitionNewsData = () => {
	...
	return (
		...
		<section
			...
			style={{
				backgroundImage: "url(images/bg/underline_02_Beige_1920x292.svg)",
			}}>
										...
										<div className="card_figure">
											<div className="img-wrapper">
												<img
													...
													src="/images/exhibition/exhibition_IMG_01.jpg"
												/>
											</div>
										</div>
