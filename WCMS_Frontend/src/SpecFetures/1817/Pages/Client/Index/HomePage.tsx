    ...
    <main id="fullpage" className="fullpage-wrapper">
      <div className="bg_area">
        <div className="mainArea" id="mainArea">
          ...
          <CarouselData
            lang={props.lang}
            internalId={loaderData.args.carouselBannerInternalId}
            initialBanner={rawData.carouselBanner}
          />
          ...
          <SpecialLinkData
            lang={props.lang}
            internalId={loaderData.args.specialLinkBannerInternalId}
            initialBanner={rawData.specialLinkBanner}
          />
        </div>
      </div>
    </main>
