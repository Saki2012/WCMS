    ...
    class Ks extends W {
        ...
        _deactivate(t, e) {
            t && (t.classList.remove(Fs), t.blur(), this._deactivate(z.getElementFromSelector(t)), this._queueCallback((() => {
				...
				// JESS 新修正 tabindex", "-1" 改為 "拿掉" 20250708 //
                //"tab" === t.getAttribute("role") ? (t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", "-1"), this._toggleDropDown(t, !1), N.trigger(t, Os, {
				"tab" === t.getAttribute("role") ? (t.setAttribute("aria-selected", !1), this._toggleDropDown(t, !1), N.trigger(t, Os, {
				// JESS 新修正 tabindex", "-1" 改為 "拿掉" 20250708 //
        ...
        _setInitialAttributesOnChild(t) {
			...
			t.setAttribute("aria-selected", e), i !== t && this._setAttributeIfNotExists(i, "role", "presentation"), e || this._setAttributeIfNotExists(t, "role", "tab"), this._setInitialAttributesOnTargetPanel(t)
        	// JESS 新修正 tabindex", "-1" 改為 "拿掉" 20250708 //
		}
