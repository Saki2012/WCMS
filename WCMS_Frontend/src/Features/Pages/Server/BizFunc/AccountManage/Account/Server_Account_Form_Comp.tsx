            ...
            <div className="row">
                <div className="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-12">
                    <LibUserCard 
                        ...
                        DisplayRole={"角色"} PicSrc={userPic} Style={vm.prop.Theme.UserCard} 
                    />
                </div>
...
const Account_Comp = (props: {theme: IBETheme; formData: UseFetchFormDataResult<AccountSet>; accountStatus: Record<string, string>; 
    personIds: Record<string, string>; roleIds: Record<string, string>; isAddNew: boolean; confirmPwd: string; onConfirmPwdChange: (v: string) => void;}) => 
{
