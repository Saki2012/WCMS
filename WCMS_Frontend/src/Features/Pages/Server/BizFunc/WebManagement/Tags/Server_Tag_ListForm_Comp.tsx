...
export const TagListFormComp = (prop: { progId: string; title: string; theme: IBETheme; lang: Lang }) => {
    ...
    const actions = useActions(dirUrl, TagProvider(), formData.data, internalId ?? "", useTagList.refetchFirst)
    ...
    const tagListNode = useMemo(() => useTagList.rawData ? (<TagListComp theme={prop.theme} tagSets={useTagList.rawData} lang={prop.lang} actions={actions} />) : null, [prop.theme, useTagList.rawData, internalId, prop.lang, prop.progId, pathname]);
    return (
