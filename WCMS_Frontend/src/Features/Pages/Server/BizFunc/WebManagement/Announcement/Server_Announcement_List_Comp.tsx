...
export const Server_AnnouncementListComp = ({ title, theme }: { title: string; theme: IBETheme }) => {
    ...
    const adjustedGrid = useMemo(() => { return SetAdjustFunction(dirUrl, useAnnounceList.gridProps, useAnnounceList.rawData, useCategory.rawData); }, [useAnnounceList.gridProps, useAnnounceList.rawData, useCategory.rawData]);
