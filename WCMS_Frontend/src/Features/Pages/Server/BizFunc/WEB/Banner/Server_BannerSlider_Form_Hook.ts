...
export const useBannerSliderFormFetchData = (
    opt: { lang: Lang; internalId: string; emptyData: BannerSet; actionsOpt: BannerSliderFormActionsOpt; },
): UseFetchDataResult<BannerSliderFormRawData, BannerSliderFormAdapter> =>
{
    ...
    const adapter = useMemo<BannerSliderFormAdapter>(() =>
    {
    ...
    {
        return [Boolean(formData.isLoading)];
    }, [formData.isLoading]);
    ...
    const rawData = useMemo<BannerSliderFormRawData>(() =>
    {
