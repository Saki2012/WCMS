...
export const useWebResourceFormFetchData = (
    opt: { lang: Lang; internalId: string; emptyData: WebResourceSet; actionsOpt: WebResourceFormActionsOpt; },
): UseFetchDataResult<WebResourceFormRawData, WebResourceFormAdapter> =>
{
    ...
    const loadingList = useMemo<boolean[]>(() =>
    {
        return [
            ...
            Boolean(windowTarget.isLoading),
        ];
    ...
    {
        return [category.errorText, formData.error, tag.errorText, statusOpts.error, windowTarget.error];
