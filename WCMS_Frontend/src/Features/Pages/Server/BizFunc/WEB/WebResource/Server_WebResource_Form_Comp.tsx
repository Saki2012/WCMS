...
export const WebResourceFormComp = (prop: { theme: IBETheme; lang: Lang; }) =>
{
    ...
    const windowsTarget = useMemo(() =>
    {
        return new Map<string, string>(Object.entries(getData.rawData.windowsTarget ?? {}));
    }, [getData.rawData.windowsTarget]);
    return (
    ...
    const componentsA: Record<string, React.ReactNode[]> = {
        ...
        Status: [
            <LibCheckBox
                ...
                {...setField(WebResourceSetFields.WebResource, WebResourceFields.ContentStatus, "number", undefined, {
                    strategy: "sum",
        ...
        Tags: [
            <LibCheckBox
                ...
                {...setField(WebResourceSetFields.WebResource, WebResourceFields.Tags, "string", undefined, "csv")}
            />,
        ],
        Img: [
            <LibFile
