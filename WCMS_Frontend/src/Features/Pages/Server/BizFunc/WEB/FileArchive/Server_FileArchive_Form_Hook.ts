...
export const useFileArchiveFormFetchData = (
    opt: { lang: Lang; internalId: string; emptyData: FileArchiveSet; actionsOpt: FileArchiveFormActionsOpt; },
): UseFetchDataResult<FileArchiveFormRawData, FileArchiveFormAdapter> =>
{
    ...
    const adapter = useMemo<FileArchiveFormAdapter>(() =>
    {
