...
import { type Lang, useEnsureLangDetails } from "@/SysCore/i18n/lang";
...
export const useAnnouncementFormFetchData = (
    opt: { lang: Lang; internalId: string; emptyData: AnnouncementSet; actionsOpt: AnnouncementFormActionsOpt; },
