...
import type { ServerFormBinding, ServerFormDefaultRawData, ServerFormTemplate } from "@/Features/Pages/Server/Scaffold/Content/FormTemplate/Server_FormTemplate_Hook";
...
const normalizePermissionProgs = (progs: PermissionCatalogProg[] | null | undefined): PermissionCatalogProgDTO[] =>
{
