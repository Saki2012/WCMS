...
const DTOBasicDataModelFields = {
    CreateTime: "CreateTime", CreateUserId: "CreateUserId", CreateUser: "CreateUser",
    ModifyTime: "ModifyTime", ModifyUserId: "ModifyUserId", ModifyUser: "ModifyUser",
} as const;
    ...
    return (
        <>
            ...
            <div className="col-12 form-group">
                <LibTextBox Style={props.theme.TextBox3} {...setField(props.setKey, DTOBasicDataModelFields.CreateUserId, "string")} InputValue={createUserDisplay} disabled={true} />
                <LibTextBox Style={props.theme.TextBox3} {...setField(props.setKey, DTOBasicDataModelFields.ModifyUserId, "string")} InputValue={modifyUserDisplay} disabled={true} />
            </div>
            {/* 修改人員/修改時間 */}
            <div className="col-12 form-group">
                <LibTextBox Style={props.theme.TextBox3} {...setField(props.setKey, DTOBasicDataModelFields.CreateTime, "datetime")} InputValue={FormatDateTime(mainRow?.[DTOBasicDataModelFields.CreateTime])} disabled={true} />
                <LibTextBox Style={props.theme.TextBox3} {...setField(props.setKey, DTOBasicDataModelFields.ModifyTime, "datetime")} InputValue={FormatDateTime(mainRow?.[DTOBasicDataModelFields.ModifyTime])} disabled={true} />
            </div>
