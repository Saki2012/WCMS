...
export const SkipToContent: React.FC<SkipToContentProps> = ({ lang }) =>
{
    ...
    return (
        <>
            ...
            <a href="#AC" id="gotocenter" title={text.skip} aria-label={text.skip} tabIndex={1} className="visually-hidden-focusable">
                {text.skip}
            </a>
        </>
    );
