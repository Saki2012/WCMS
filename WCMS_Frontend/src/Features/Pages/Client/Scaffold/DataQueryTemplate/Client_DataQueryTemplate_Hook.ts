...
export type ClientDataQueryMode = "multiple" | "single";
...
interface ClientDataQueryViewModelContext<TSearchParams, TRawData, TAdapter, TQueryParam, TLoaderData>
    extends ClientDataQueryDataSourceContext<TSearchParams, TQueryParam, TLoaderData>
{
    /** useDataSource 回傳的原始資料 */
    rawData: TRawData;
...
/** Hook 回傳資料 */
export interface ClientDataQueryTemplateResult<TSearchParams, TRawData, TViewModel, TAdapter = unknown, TQueryParam = QueryListParam, TLoaderData = unknown>
    extends ClientDataQueryBuiltState<TSearchParams, TQueryParam>
{
    /** 功能識別碼 */
    featureKey: string;
...
): ClientDataQueryBuiltState<TSearchParams, TQueryParam> =>
{
    ...
    const conditionCtx: ClientDataQueryConditionContext<TSearchParams> = {
...
): ClientDataQueryTemplateResult<TSearchParams, TRawData, TViewModel, TAdapter, TQueryParam, TLoaderData> =>
{
    ...
    {
        return buildClientDataQueryState(template, submittedValues, viewState);
    }, [template, submittedValues, viewState]);
