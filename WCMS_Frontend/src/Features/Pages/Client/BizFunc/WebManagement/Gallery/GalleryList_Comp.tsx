...
import { useGalleryListFetchData, type IGalleryListOptions, } from "./GalleryList_Loader";
...
const GalleryList = (props: IGalleryListProps) =>
{
    ...
    const paginatorProps = useMemo<PaginatorProps>(() =>{ return {currentPage: galleryData.pageNumber, totalPages: galleryData.totalPages, onPageChange: galleryData.onPageChange,}; }, [galleryData.pageNumber, galleryData.totalPages, galleryData.onPageChange]);
  
    const viewCountConfig = useMemo<ModuleViewCountConfig>(() =>{ return { mode: "list" }; }, []);
                                ...
                                <div className="card_content">
                                    ...
                                    <div className="card_catDiv">
                                        ...
                                        <div className="card_time">
                                            <i className="far fa-clock mr-2"></i><span className="sr-only">日期</span>{validateStart}
                                        </div>
                                    </div>
