...
function menu_click() {
  ...
  var elem = document.querySelectorAll('.pc-navbar li:not(.open-trigger) .pc-submenu');
  for (var j = 0; j < elem.length; j++) {
  ...
  for (var i = 0; i < pc_link_click.length; i++) {
    pc_link_click[i].addEventListener('click', function (event) {
      ...
      if (targetElement.parentNode.classList.contains('open-trigger')) {
        targetElement.parentNode.classList.remove('open-trigger');
        ...
        var tc = document.querySelectorAll('li.open-trigger');
        for (var t = 0; t < tc.length; t++) {
          var c = tc[t];
          c.classList.remove('open-trigger');
        ...
        targetElement.parentNode.classList.add('open-trigger');
...
for (var l = 0; l < elem.length; l++) {
  ...
  if (elem[l].href == pageUrl && elem[l].getAttribute('href') != '') {
    ...
    elem[l].parentNode.parentNode.parentNode.classList.add('open-trigger');
    elem[l].parentNode.parentNode.parentNode.classList.add('active');
    elem[l].parentNode.parentNode.style.display = 'block';

    elem[l].parentNode.parentNode.parentNode.parentNode.parentNode.classList.add('open-trigger');
