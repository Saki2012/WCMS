...
var c3 = {
    version: "0.7.20",
    chart: { fn: Chart.prototype, internal: { fn: ChartInternal.prototype, axis: { fn: Axis.prototype, internal: { fn: AxisInternal.prototype } } } },
...
ChartInternal.prototype.initWithData = function(data)
{
    ...
    if (binding)
    {
        $$.updateDimension();
        $$.config.oninit.call($$);
        $$.redraw({ withTransition: false, withTransform: true, withUpdateXDomain: true, withUpdateOrgXDomain: true, withTransitionForAxis: false });
    }
...
ChartInternal.prototype.smoothLines = function(el, type)
{
    ...
    if (type === "grid")
    {
        el.each(function()
        {
            ...
            g.attr({ x1: Math.ceil(x1), x2: Math.ceil(x2), y1: Math.ceil(y1), y2: Math.ceil(y2) });
        });
    }
};
...
ChartInternal.prototype.updateSizes = function()
{
    ...
    $$.margin2 = config.axis_rotated
        ? { top: $$.margin.top, right: NaN, bottom: 20 + legendHeightForBottom, left: $$.rotated_padding_left }
        : {
...
ChartInternal.prototype.redraw = function(options, transitions)
{
    ...
    main.select("text." + CLASS.text + "." + CLASS.empty).attr("x", $$.width / 2).attr("y", $$.height / 2).text(config.data_empty_label_text).transition()
...
{
    this.redraw({ withY: false, withSubchart: false, withEventRect: false, withTransitionForAxis: false });
};
...
ChartInternal.prototype.updateSvgSize = function()
{
    ...
    $$.svg.select("#" + $$.clipIdForXAxis).select("rect").attr("x", $$.getXAxisClipX.bind($$)).attr("y", $$.getXAxisClipY.bind($$)).attr(
        "width",
        $$.getXAxisClipWidth.bind($$),
    ).attr("height", $$.getXAxisClipHeight.bind($$));
    $$.svg.select("#" + $$.clipIdForYAxis).select("rect").attr("x", $$.getYAxisClipX.bind($$)).attr("y", $$.getYAxisClipY.bind($$)).attr(
        "width",
        $$.getYAxisClipWidth.bind($$),
