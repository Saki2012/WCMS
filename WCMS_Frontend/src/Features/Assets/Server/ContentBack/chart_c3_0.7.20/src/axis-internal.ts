...
AxisInternal.prototype.generateAxis = function()
{
    ...
    function axis(g, transition)
    {
        ...
        g.each(function()
        {
            ...
            var path = g.selectAll(".domain").data([0]), pathUpdate = path.enter().append("path").merge(path).attr("class", "domain");
    ...
    axis.tickInterval = function()
    {
        ...
        {
            length = (axis as any).g.select("path.domain").node().getTotalLength() - internal.outerTickSize * 2;
