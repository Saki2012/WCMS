...
ChartInternal.prototype.initDragZoom = function()
{
    ...
    const brush = ($$.dragZoomBrush = d3.brushX().on("start", () =>
    {
        $$.api.unzoom();
    ...
    context.append("g").classed(CLASS.dragZoom, true).attr("clip-path", $$.clipPath).attr("transform", "translate(" + brushXPos + "," + brushYPos + ")").call(
        brush,
    );
};
...
ChartInternal.prototype.redrawForZoom = function()
{
    ...
    $$.redraw({ withTransition: false, withY: config.zoom_rescale, withSubchart: false, withEventRect: false, withDimension: false });
