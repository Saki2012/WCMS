...
ChartInternal.prototype.updateRegion = function(duration)
{
    ...
    g.append("rect").attr("x", $$.regionX.bind($$)).attr("y", $$.regionY.bind($$)).attr("width", $$.regionWidth.bind($$)).attr(
        "height",
        $$.regionHeight.bind($$),
...
ChartInternal.prototype.redrawRegion = function(withTransition, transition)
{
    ...
    return [
        (withTransition ? regions.transition(transition) : regions).attr("x", $$.regionX.bind($$)).attr("y", $$.regionY.bind($$)).attr(
            "width",
            $$.regionWidth.bind($$),
        ...
        (withTransition ? regionLabels.transition(transition) : regionLabels).attr("x", $$.labelOffsetX.bind($$)).attr("y", $$.labelOffsetY.bind($$)).attr(
            "transform",
            $$.labelTransform.bind($$),
