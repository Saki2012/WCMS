...
describe("c3 chart domain", function()
{
    ...
    var args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 50, 20, 10, 40, 15, 25]] }, axis: { y: {}, y2: {} } };
    ...
    describe("axis.y.padding", function()
    {
        describe("should change axis.y.max to 1000", function()
        {
            beforeAll(function()
            {
                args = { data: { columns: [["data1", 10, 20, 10, 40, 15, 25], ["data2", 50, 40, 30, 45, 25, 45]] }, axis: { y: { padding: 200 }, y2: {} } };
            });
        ...
        describe("should change axis.y.max to 1000 with top/bottom padding", function()
        {
            ...
            {
                args = {
                    data: { columns: [["data1", 10, 20, 10, 40, 15, 25], ["data2", 50, 40, 30, 45, 25, 45]] },
                    axis: { y: { padding: { top: 200, bottom: 200 } }, y2: {} },
                };
            });
