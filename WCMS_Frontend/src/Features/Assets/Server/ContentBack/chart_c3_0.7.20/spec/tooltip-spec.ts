...
describe("c3 chart tooltip", function()
{
        ...
        beforeAll(function()
        {
            tooltipConfiguration = {
                position: function(data, width, height, element)
                {
                    ...
                    expect(data[0]).toEqual(jasmine.objectContaining({ index: 2, value: 100, id: "data1" }));
    ...
    describe("tooltip getTooltipContent", function()
    {
        beforeAll(function()
        {
            tooltipConfiguration = { data_order: "desc" };
        });
    ...
    describe("tooltip with tooltip_order as desc", function()
    {
        beforeAll(function()
        {
            tooltipConfiguration = { order: "desc" };
    ...
    describe("tooltip with tooltip_order as asc", function()
    {
        beforeAll(function()
        {
            tooltipConfiguration = { order: "asc" };
    ...
    describe("tooltip with tooltip_order as NULL", function()
    {
        beforeAll(function()
        {
            tooltipConfiguration = { order: null };
        });
    ...
    describe("tooltip with tooltip_order as Array", function()
    {
        beforeAll(function()
        {
            tooltipConfiguration = { order: ["data2", "data1", "data3"] };
        });
