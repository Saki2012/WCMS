...
describe("util.js tests", function()
{
    ...
    describe("getIEVersion and isIE", function()
    {
        ...
        {
            expect(getIEVersion("Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.71 Safari/537.36 Edge/12.0"))
                .toBe(false);
        });
