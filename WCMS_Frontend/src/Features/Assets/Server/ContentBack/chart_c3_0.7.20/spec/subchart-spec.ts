...
describe("c3 subchart", function()
{
    ...
    let args = {
        data: {
            x: "date",
            columns: [["date", "2012-12-24", "2012-12-25", "2012-12-26", "2012-12-27", "2012-12-28", "2012-12-29"], ["data1", 30, 200, -100, 400, -150, 250], [
                "data2",
                50,
                20,
                10,
    ...
    const getChartHeight = () => +chart.internal.svg.select(".c3-event-rect").attr("height") - 1;
