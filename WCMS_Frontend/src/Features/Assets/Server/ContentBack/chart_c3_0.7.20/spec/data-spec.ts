...
describe("c3 chart data", function()
{
    ...
    describe("load json", function()
    {
        beforeAll(function()
        {
            args = { data: { json: { data1: [30, 20, 50], data2: [200, 130, 90] } } };
        });
        ...
        describe("more data", function()
        {
            beforeAll(function()
            {
                args = {
                    data: {
                        json: [{ date: "2014-06-03", "443": "3000", "995": "500" }, { date: "2014-06-04", "443": "1000" }, {
                            date: "2014-06-05",
                            "443": "5000",
                            "995": "1000",
                        }],
                        keys: { x: "date", value: ["443", "995"] },
                    },
            ...
            beforeAll(function()
            {
                args = {
                    data: {
                        ...
                        keys: { x: "date", value: ["443", "995.996", "112[0]", "223[0].224", "334[1][0].335", "556.557.558[0]", "778.889"] },
                    },
                    axis: { x: { type: "category" } },
                };
            });
    ...
    describe("load rows", function()
    {
        ...
        {
            args = {
                data: { rows: [["data1", "data2", "data3"], [90, 120, 300], [40, 160, 240], [50, 200, 290], [120, 160, 230], [80, 130, 300], [90, 220, 320]] },
            };
        });
    ...
    describe("function in data.order", function()
    {
        beforeAll(function()
        {
            args = {
                data: {
                    columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 50, 20, 10, 40, 15, 25], ["data3", 150, 120, 110, 140, 115, 125]],
                    order: function()
                    {
                        return 0;
                    },
    ...
    describe("addHiddenTargetIds if not already hidden", function()
    {
        ...
        {
            args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 150, 120, 110, 140, 115, 125]] } };
    ...
    describe("data.xs", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 50, 20, 10, 40, 15, 25], ["data3", 150, 120, 110, 140, 115, 125]] } };
        });
        ...
        describe("timeseries x", function()
        {
            describe("without xFormat", function()
            {
                ...
                {
                    args = {
                        data: { x: "date", columns: [["date", "2013-01-01", "2013-01-02", "2013-01-03"], ["data1", 30, 200, 100], ["data2", 130, 300, 200]] },
                    ...
                    beforeAll(function()
                    {
                        args = {
                            data: {
                                x: "date",
                                xFormat: "%Y%m%d",
                                columns: [["date", "20130101", "20130102", "20130103"], ["data1", 30, 200, 100], ["data2", 130, 300, 200]],
                            },
                            axis: { x: { type: "timeseries" } },
                        };
                    });
        ...
        describe("milliseconds timeseries x", function()
        {
                ...
                beforeAll(function()
                {
                    args = {
                        data: {
                            ...
                            columns: [["date", "2014-05-20 17:25:00.123", "2014-05-20 17:30:00.345"], ["data1", 30, 200], ["data2", 130, 300]],
                        },
                        axis: { x: { type: "timeseries", tick: { format: "%Y-%m-%d %H:%M:%S.%L", multiline: false } } },
                    };
                });
            ...
            describe("as unixtime number", function()
            {
                ...
                {
                    args = {
                        data: { x: "date", columns: [["date", 1417622461123, 1417622522345], ["data1", 30, 200], ["data2", 130, 300]] },
                        axis: { x: { type: "timeseries", tick: { format: "%Y-%m-%d %H:%M:%S.%L" } } },
                    };
                });
    ...
    describe("data.label", function()
    {
        describe("on line chart", function()
        {
            beforeAll(function()
            {
                args = {
                    data: {
                        columns: [["data1", 1030, 2200, 2100], ["data2", 1150, 2010, 1200], ["data3", -1150, -2010, -1200], ["data4", -1030, -2200, -2100]],
                        type: "line",
                        labels: true,
                    },
                };
            ...
            {
                var expectedTextY = { data1: [128, 38, 46], data2: [119, 53, 115], data3: [311, 377, 315], data4: [302, 392, 384] };
                var expectedTextX = { data1: [6, 294, 583], data2: [6, 294, 583], data3: [6, 294, 583], data4: [6, 294, 583] };
            ...
            describe("with stacked", function()
            {
                ...
                it("should locate data labels in correct position", function()
                {
                    var expectedTextY = { data1: [120, 38, 75], data2: [161, 127, 159], data3: [269, 303, 271], data4: [310, 392, 355] };
                    var expectedTextX = { data1: [6, 294, 583], data2: [6, 294, 583], data3: [6, 294, 583], data4: [6, 294, 583] };
                    Object.keys(expectedTextY).forEach(function(key)
                    {
                        d3.selectAll(".c3-texts-" + key + " text.c3-text").each(function(d, i)
        ...
        describe("on bar chart", function()
        {
            ...
            {
                var expectedTextY = { data1: [128, 38, 46], data2: [119, 53, 115], data3: [311, 377, 315], data4: [302, 392, 384] };
                var expectedTextX = { data1: [53, 249, 445], data2: [83, 279, 475], data3: [112, 308, 504], data4: [142, 338, 534] };
                Object.keys(expectedTextY).forEach(function(key)
                {
                    d3.selectAll(".c3-texts-" + key + " text.c3-text").each(function(d, i)
                    {
            ...
            describe("with stacked", function()
            {
                ...
                {
                    var expectedTextY = { data1: [120, 38, 75], data2: [161, 127, 159], data3: [269, 303, 271], data4: [310, 392, 355] };
                    var expectedTextX = { data1: [68.6, 264, 460], data2: [68.6, 264, 460], data3: [127, 323, 519], data4: [127, 323, 519] };
                    Object.keys(expectedTextY).forEach(function(key)
                    {
                        d3.selectAll(".c3-texts-" + key + " text.c3-text").each(function(d, i)
                        {
        ...
        describe("for all targets", function()
        {
            describe("with data label for all data", function()
            {
                beforeAll(function()
                {
                    args = {
                        data: {
                            columns: [["data1", 100, 200, 100, 400, 150, 250], ["data2", 10, 20, 10, 40, 15, 25], [
                                "data3",
                                1000,
                                2000,
                                1000,
        ...
        describe("with small values", function()
        {
            describe("with data label", function()
            {
                beforeAll(function()
                {
                    args = { data: { columns: [["data1", 0.03, 0.2, 0.1, 0.4, 0.15, 0.25]], labels: true } };
                });
            ...
            describe("on non rotated axis", function()
            {
                describe("data type bar", function()
                {
                    beforeAll(function()
                    {
                        args = {
                            data: {
                                columns: [["data1", 30, 200, 100, 500], ["data2", 50, 20, 10, 40], ["data3", 250, 220, 210, 240]],
    ...
    describe("data.stack", function()
    {
        ...
        {
            args = {
                data: { columns: [["data1", 230, 50, 300], ["data2", 198, 87, 580]], type: "bar", groups: [["data1", "data2"]], stack: { normalize: true } },
            };
        });

        const getChartHeight = () => +chart.internal.main.select(`.c3-event-rect`).attr("height") - 1;
        ...
        describe("timeseries chart", () =>
        {
            beforeAll(function()
            {
                args = {
                    data: {
                        x: "date",
                        columns: [["date", "2012-12-24", "2012-12-25", "2012-12-26"], ["data1", 30, 200, 400], ["data2", 50, 60, 50]],
                        groups: [["data1", "data2"]],
                        type: "bar",
        ...
        describe("area chart", () =>
        {
            beforeAll(() =>
            {
                args = {
                    data: {
                        columns: [["data1", 200, 387, 123], ["data2", 200, 387, 123]],
                        type: "area",
                        groups: [["data1", "data2"]],
                        stack: { normalize: true },
                    },
