import { d3, initChart, setMouseEvent } from "./c3-helper";
...
describe("c3 chart interaction", function()
{
    ...
    const moveMouseOut = () => setMouseEvent(chart, "mouseout", 0, 0, d3.select(".c3-event-rect").node());

    const moveMouse = (x = 0, y = 0) => setMouseEvent(chart, "mousemove", x, y, d3.select(".c3-event-rect").node());

    const clickMouse = (x = 0, y = 0) => setMouseEvent(chart, "click", x, y, d3.select(".c3-event-rect").node());
    ...
    describe("generate event rects", function()
    {
        describe("custom x", function()
        {
            beforeAll(function()
            {
                args = { data: { x: "x", columns: [["x", 0, 1000, 3000, 10000], ["data", 10, 10, 10, 10]], type: "bar" } };
            });
            ...
            describe("mouseover", function()
            {
                ...
                it("should be data value when within bar", function()
                {
                    ...
                    expect(chart.internal.mouseover).toEqual({ x: 0, value: 30, index: 0, id: "data1", name: "data1" });
                });
        ...
        describe("timeseries", function()
        {
            beforeAll(function()
            {
                args = { data: { x: "x", columns: [["x", "20140101", "20140201", "20140210", "20140301"], ["data", 10, 10, 10, 10]] } };
            });
    ...
    describe("bar chart", function()
    {
        describe("tooltip_grouped=true", function()
        {
            beforeAll(() =>
            {
                args = {
                    data: {
                        columns: [["data1", 30, 200, 200, 400, 150, -250], ["data2", 130, -100, 100, 200, 150, 50], ["data3", 230, -200, 200, 0, 250, 250]],
                        type: "bar",
                        groups: [["data1", "data2"]],
                        hide: ["data1"],
                    },
            ...
            it("shows tooltip with visible data of currently hovered category", () =>
            {
                ...
                expect((document.querySelector(".c3-tooltip-container") as any).style.display).toEqual("block");

                const tooltipData = [...(document.querySelectorAll(".c3-tooltip tr") as any)];
            ...
            it("expands all bars of currently hovered category", () =>
            {
                ...
                {
                    if ((this as any).classList.contains("c3-bar-0") && !(this as any).parentElement.classList.contains("c3-bars-data1"))
                    {
                ...
                barList.each(function()
                {
                    if ((this as any).classList.contains("c3-bar-2") && !(this as any).parentElement.classList.contains("c3-bars-data1"))
                    {
                        expect((this as any).classList.contains("_expanded_")).toBeTruthy();
                    } else
                    {
        ...
        describe("tooltip_grouped=false", function()
        {
            ...
            it("shows tooltip with only hovered data", () =>
            {
                ...
                expect((document.querySelector(".c3-tooltip-container") as any).style.display).toEqual("none");
            ...
            it("expands only hovered bar", () =>
            {
                ...
                barList.each(function()
                {
                    if ((this as any).classList.contains("c3-bar-0") && (this as any).parentElement.classList.contains("c3-bars-data2"))
                    {
                        expect((this as any).classList.contains("_expanded_")).toBeTruthy();
                    } else
                    {
        ...
        describe("tooltip_grouped=false", function()
        {
            ...
            beforeAll(() =>
            {
                args = {
                    ...
                    axis: { x: { type: "category" } },
                    interaction: { enabled: true },
                    point: { r: 2, sensitivity: 10, focus: { expand: { enabled: true, r: 8 } } },
                };
            });
            ...
            it("expands only hovered point", () =>
            {
                ...
                circleList.each(function()
                {
                    expect((this as any).classList.contains("_expanded_")).toEqual(
                        (this as any).classList.contains("c3-circle-0") && (this as any).parentElement.classList.contains("c3-circles-data2"),
                    );
                });
            });
            ...
            it("clicks only on hovered point", () =>
            {
                ...
                expect(clickedData).toEqual([{ x: 1, index: 1, value: 200, id: "data1", name: "data1" }]);
            });
            ...
            describe("with tooltip_horizontal=true", () =>
            {
                ...
                it("can clicks on points", () =>
                {
                    ...
                    expect(clickedData).toEqual([{ x: 1, value: -200, id: "data3", index: 1, name: "data3" }, {
                        x: 3,
                        value: 200,
                        id: "data2",
                        index: 3,
                ...
                it("shows tooltip with only closest data", () =>
                {
                    ...
                    let tooltipData = [...(document.querySelectorAll(".c3-tooltip tr") as any)];
        ...
        beforeAll(() =>
        {
            args = {
                data: {
                    ...
                    columns: [["x1", 10, 30, 45, 50, 70, 100], ["x2", 30, 50, 75, 100, 120], ["data1", 30, 200, 100, 400, 150, 250], [
                        "data2",
                        20,
                        180,
                        240,
                ...
                tooltip: { grouped: true, horizontal: true },
                interaction: { enabled: true },
            };
        });
    ...
    describe("scatter chart", function()
    {
        describe("tooltip_grouped=true", function()
        {
            beforeAll(() =>
            {
                args = {
                    data: {
                        columns: [["data1", 30, null, 100, 400, -150, 250], ["data2", 50, 20, 10, 40, 15, 25], ["data3", -150, 120, 110, 140, 115, 125]],
                        type: "scatter",
                    },
                    tooltip: { grouped: true },
                    interaction: { enabled: true },
        ...
        describe("tooltip_grouped=false", function()
        {
            beforeAll(() =>
            {
                args = {
                    ...
                    tooltip: { grouped: false },
                    axis: { x: { type: "timeseries" }, rotated: false },
                    interaction: { enabled: true },
                };
            });
