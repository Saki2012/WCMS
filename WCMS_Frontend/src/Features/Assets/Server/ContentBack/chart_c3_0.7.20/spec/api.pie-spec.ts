...
describe("c3 api pie", function()
{
    ...
    args = { data: { columns: [["data1", 60], ["data2", 40]], type: "pie" }, pie: { padAngle: 0.5 } };
    ...
    describe("load data", function()
    {
        beforeAll(() =>
        {
            args = { data: { columns: ["r", "l", "d"], type: "pie", colors: { r: "red", l: "green", d: "blue" } } };
        });

        it("can add data point to existing data", () =>
        {
            chart.load({ columns: [["r", 75], ["l", 20], ["d", 5]] });
