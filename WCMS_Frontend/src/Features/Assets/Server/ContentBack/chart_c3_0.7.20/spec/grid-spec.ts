...
describe("c3 chart grid", function()
{
    ...
    describe("y grid show", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250]] }, axis: { y: { tick: {} } }, grid: { y: { show: false } } };
        });
    ...
    describe("y grid lines", function()
    {
        describe("position", function()
        {
            ...
            {
                args = {
                    data: { columns: [["data1", 10, 200, 100, 400, 150, 250]] },
                    grid: {
                        y: {
                            lines: [{ value: 30, text: "Label 30", position: "start" }, { value: 145, text: "Label 145", position: "middle" }, {
                                value: 225,
                                text: "Label 225",
                            }],
                        },
    ...
    describe("x grid lines", function()
    {
        describe("position", function()
        {
            beforeAll(function()
            {
                ...
                args = {
                    data: { columns: [["data1", 30, 200, 100, 400]] },
                    grid: {
                        x: {
                            lines: [{ value: 1, text: "Label 1", position: "start" }, { value: 2, text: "Label 2", position: "middle" }, {
                                value: 3,
                                text: "Label 3",
                            }],
                        },
        ...
        describe("with padding.top", function()
        {
            describe("should have correct height", function()
            {
                beforeAll(function()
                {
                    args = { data: { columns: [["data1", 30, 200, 100, 400]] }, grid: { x: { lines: [{ value: 3, text: "Label 3" }] } }, padding: { top: 50 } };
                });
        ...
        describe("on category axis", function()
        {
            ...
            {
                args = {
                    data: { x: "x", columns: [["x", "a", "b", "c", "d"], ["data1", 30, 200, 100, 400]] },
                    axis: { x: { type: "category" } },
                    grid: { x: { lines: [{ value: 3, text: "Label 3" }, { value: "a", text: "Label a" }] } },
                };
            });
