...
describe("c3 api zoom", function()
{
    ...
    describe("zoom", function()
    {
        ...
        describe("with timeseries data", function()
        {
            ...
            {
                args = {
                    data: { x: "date", columns: [["date", "2014-01-01", "2014-01-02", "2014-08-01", "2014-10-19"], ["data1", 30, 200, 100, 400]] },
    ...
    describe("unzoom", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250]] }, zoom: { enabled: true } };
        });
