...
describe("c3 api region", function()
{
    ...
    describe("api.region", function()
    {
        beforeAll(function()
        {
            args = {
                ...
                regions: [{ axis: "y", start: 300, end: 400, class: "green", label: "Region 1" }, { axis: "y", start: 0, end: 100, class: "green" }],
            };
        });
        ...
        it("updates regions", function(done)
        {
            var main = chart.internal.main,
                expectedRegions = [{ axis: "y", start: 250, end: 350, class: "red", label: "Region 1" }, {
                    axis: "y",
                    start: 25,
                    end: 75,
                    class: "red",
    ...
    describe("api.region.add", function()
    {
        beforeAll(function()
        {
            args = {
                data: { columns: [["data1", 30, 200, 100, 400, 150, 250]] },
                regions: [{ axis: "y", start: 300, end: 400, class: "green" }, { axis: "y", start: 0, end: 100, class: "green" }],
            };
        });
        ...
        {
            var main = chart.internal.main,
                expectedRegions = [{ axis: "y", start: 300, end: 400, class: "green" }, { axis: "y", start: 0, end: 100, class: "green" }, {
                    axis: "y",
                    start: 250,
                    end: 350,
                    class: "red",
                }, { axis: "y", start: 25, end: 75, class: "red" }],
    ...
    describe("api.region.remove", function()
    {
        ...
        {
            var main = chart.internal.main, expectedRegions = [{ axis: "y", start: 250, end: 350, class: "red" }], expectedClasses = ["red"], regions;
