...
describe("c3 api grid", function()
{
    ...
    describe("ygrid.add and ygrid.remove", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250]] } };
        });

        it("updates y grids", function(done)
        {
            var main = chart.internal.main, expectedGrids = [{ value: 100, text: "Pressure Low" }, { value: 200, text: "Pressure High" }], grids;
        ...
        {
            var main = chart.internal.main, expectedGrids = [{ value: 0, text: "Pressure Low" }, { value: 1, text: "Pressure High" }], grids, domain;
