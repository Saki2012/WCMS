...
describe("c3 chart legend", function()
{
    ...
    describe("legend when multiple charts rendered", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["data1", 30], ["data2", 50], ["data3", 100]] } };
        });
        ...
        describe("long data names", function()
        {
            beforeAll(function()
            {
                args = { data: { columns: [["long data name 1", 30], ["long data name 2", 50], ["long data name 3", 50]] } };
            });
    ...
    describe("legend position", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 50, 20, 10, 40, 15, 25]] } };
        });
    ...
    describe("legend as inset", function()
    {
        describe("should change the legend to \"inset\" successfully", function()
        {
            beforeAll(function()
            {
                args = {
                    ...
                    legend: { position: "inset", inset: { step: null } },
                };
            });

            it("should be positioned properly", function()
            {
                var box = (d3.select(".c3-legend-background").node() as any).getBoundingClientRect();
        ...
        describe("with only one series", function()
        {
            beforeAll(function()
            {
                args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250]] }, legend: { position: "inset" } };
            });
    ...
    describe("legend.hide", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 130, 100, 200, 100, 250, 150]] }, legend: { hide: true } };
        });
        ...
        describe("hidden legend", function()
        {
            beforeAll(function()
            {
                args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 130, 100, 200, 100, 250, 150]] }, legend: { hide: "data2" } };
            });
    ...
    describe("legend.show", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 130, 100, 200, 100, 250, 150]] }, legend: { show: false } };
        });
    ...
    describe("with legend.show is true", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 130, 100, 200, 100, 250, 150]] }, legend: { show: true } };
        });
        ...
        it("should remove rendered every legend items", function()
        {
            ...
            d3.selectAll(".c3-legend-item").each(function()
            {
                expect(d3.select(this).style("visibility")).toBe("hidden");
                // This selects all the children, but we expect it to be empty
                expect((d3.select(this).selectAll("*") as any).length).toEqual(undefined);
            });
        });
    });
    ...
    describe("custom legend size", function()
    {
        ...
        {
            args = {
                data: { columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 130, 100, 200, 100, 250, 150]] },
                legend: { item: { tile: { width: 15, height: 2 } } },
            };
        });
        ...
        it("renders the legend item with the correct width and height", function()
        {
            d3.selectAll(".c3-legend-item-tile").each(function()
            {
                ...
                var tileWidth = Number(d3.select(this).attr("x2")) - Number(d3.select(this).attr("x1"));
    ...
    describe("custom legend padding", function()
    {
        beforeAll(function()
        {
            args = { data: { columns: [["padded1", 30, 200, 100, 400, 150, 250], ["padded2", 130, 100, 200, 100, 250, 150]] }, legend: { padding: 10 } };
        });
        ...
        it("renders the correct amount of padding on the legend element", function()
        {
            ...
            {
                var itemWidth = (d3.select(this).node() as any).parentNode.getBBox().width,
    ...
    describe("legend item tile coloring with color_treshold", function()
    {
        ...
        {
            args = {
                data: { columns: [["padded1", 100], ["padded2", 90], ["padded3", 50], ["padded4", 20]] },
                type: "gauge",
    ...
    describe("legend item tile coloring with color_treshold (more than one data value)", function()
    {
        ...
        {
            args = {
                data: { columns: [["padded1", 40, 60], ["padded2", 100, -10], ["padded3", 0, 50], ["padded4", 20, 0]] },
                type: "gauge",
                color: { pattern: ["#FF0000", "#F97600", "#F6C600", "#60B044"], threshold: { values: [30, 80, 95] } },
            };
        });
    ...
    describe("legend item tile coloring without color_treshold", function()
    {
        ...
        {
            args = {
                data: { columns: [["padded1", 100], ["padded2", 90], ["padded3", 50], ["padded4", 20]], colors: { padded1: "#60b044", padded4: "#8b008b" } },
                type: "gauge",
            };
        });
