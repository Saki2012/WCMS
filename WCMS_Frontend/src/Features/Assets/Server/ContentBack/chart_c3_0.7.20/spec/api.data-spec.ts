...
describe("c3 api data", function()
{
    ...
    var args: any = {
        data: {
            columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 5000, 2000, 1000, 4000, 1500, 2500]],
    ...
    describe("data.names()", function()
    {
        ...
        {
            var results = chart.data.names({ data1: "New Data Name 1", data2: "New Data Name 2" });
    ...
    describe("data.colors()", function()
    {
        ...
        {
            (expect(d3.select(".c3-line-data1").style("stroke")) as any).toBeHexOrRGB("#00ff00");
            (expect(d3.select(".c3-line-data2").style("stroke")) as any).toBeHexOrRGB("#ff0000");
            (expect(d3.select(".c3-legend-item-data1 .c3-legend-item-tile").style("stroke")) as any).toBeHexOrRGB("#00ff00");
            (expect(d3.select(".c3-legend-item-data2 .c3-legend-item-tile").style("stroke")) as any).toBeHexOrRGB("#ff0000");
        });
    });
    ...
    describe("data.stackNormalized()", function()
    {
        beforeEach(function(done)
        {
            args = {
                data: {
                    columns: [["data1", 30, 200, 100, 400, 150, 250], ["data2", 500, 850, 1000, 200, 350, 100]],
                    groups: [["data1", "data2"]],
...
describe("c3 api data.x", function()
{
    ...
    var args = { data: { x: "x", columns: [["x", 10, 30, 45, 50, 70, 100], ["data1", 30, 200, 100, 400, 150, 250], ["data2", 20, 180, 240, 100, 190]] } };
...
describe("c3 api data.xs", function()
{
    ...
    var args = {
        data: {
            ...
            columns: [["x1", 10, 30, 45, 50, 70, 100], ["x2", 30, 50, 75, 100, 120], ["data1", 30, 200, 100, 400, 150, 250], ["data2", 20, 180, 240, 100, 190]],
        },
    };
