...
function(t) {
    ...
    function T(t) {
        ...
        for (var n = -1,
        e = k(t, E), r = new Array(e); ++n < e;) for (var i, o = -1,
    ...
    function B(t, n) {
        ...
        function l(l) {
            ...
            l !== b && (m = m.transition(l), x = x.transition(l), N = N.transition(l), A = A.transition(l), w = w.transition(l).attr("opacity", L).attr("transform",
            function(t) {
                return isFinite(t = _(t)) ? s(t) : this.getAttribute("transform")
            }), M.attr("opacity", L).attr("transform",
            function(t) {
    ...
    function it(t, n, e, r, i, o) {
        for (var a, u = 0,
        c = n.length,
        f = o.length; u < f; ++u)(a = n[u]) ? (a.__data__ = o[u], r[u] = a) : e[u] = new et(t, o[u]);
    ...
    var wt = {}; (t.event = null, "undefined" != typeof document) && ("onmouseenter" in document.documentElement || (wt = {
    ...
    Ct.prototype = Pt.prototype = {
        ...
        data: function(t, n) {
            ...
            for (var a = o.length,
            u = new Array(a), c = new Array(a), f = new Array(a), s = 0; s < a; ++s) {
                var l = i[s],
                h = o[s],
                d = h.length,
        ...
        classed: function(t, n) {
            ...
            function(t, n) {
                return function() { (n.apply(this, arguments) ? ht: dt)(this, t)
                }
            }: n ?
            function(t) {
                return function() {
        ...
        text: function(t) {
            return arguments.length ? this.each(null == t ? pt: ("function" == typeof t ?
            function(t) {
                return function() {
        ...
        html: function(t) {
            return arguments.length ? this.each(null == t ? vt: ("function" == typeof t ?
            function(t) {
                return function() {
                    var n = t.apply(this, arguments);
    ...
    function Yt(t, n, e) {
        ...
        for (var r, i = 0,
        o = n ? n.length: 0; i < o; ++i) if ((r = n[i]).identifier === e) return Ut(t, r);
        return null
    }
    function Bt() {
    ...
    function zn(t) {
        ...
        o = On(t.g),
        a = On(t.b),
        u = Dn((.2225045 * i + .7168786 * o + .0606169 * a) / Sn);
        return i === o && o === a ? e = r = u: (e = Dn((.4360747 * i + .3850649 * o + .1430804 * a) / An), r = Dn((.0139322 * i + .0971045 * o + .7141733 * a) / kn)),
    ...
    function qe(t, n) {
        ...
        e = function(t) {
            ...
            e = function(t) {
                var n, e = t * r,
                u = Re(g),
                c = a / (Ce * d) * (u * (n = Ee * e + g, ((n = Math.exp(2 * n)) - 1) / (n + 1)) -
                function(t) {
                    return ((t = Math.exp(t)) - 1 / t) / 2
                } (g));
    ...
    function Nr(t, n, e) {
        ...
        return t.each(function() {
            var t = xr(this, r); (t.value || (t.value = {}))[n] = e.apply(this, arguments)
        }),
        function(t) {
    ...
    Er.prototype = Cr.prototype = {
        ...
        select: function(t) {
            ...
            i = r.length,
            o = new Array(i), a = 0; a < i; ++a) for (var u, c, f = r[a], s = f.length, l = o[a] = new Array(s), h = 0; h < s; ++h)(u = f[h]) && (c = t.call(u, u.__data__, h, f)) && ("__data__" in u && (c.__data__ = u.__data__), l[h] = c, br(l[h], n, e, h, l, wr(u, e)));
        ...
        transition: function() {
            ...
            n = this._id,
            e = Pr(), r = this._groups, i = r.length, o = 0; o < i; ++o) for (var a, u = r[o], c = u.length, f = 0; f < c; ++f) if (a = u[f]) {
                var s = wr(a, n);
                br(a, t, e, f, u, {
        ...
        style: function(t, n, e) {
            ...
            } (t, r)).on("end.style." + t, kr(t)) : "function" == typeof n ? this.styleTween(t,
            function(t, n, e) {
                var r, i, o;
                return function() {
                    var a = ct(this, t),
    ...
    Pt.prototype.transition = function(t) {
        ...
        for (var r = this._groups,
        i = r.length,
        o = 0; o < i; ++o) for (var a, u = r[o], c = u.length, f = 0; f < c; ++f)(a = u[f]) && br(a, t, n, f, u, e || ci(a, n));
    ...
    function Pi(n) {
        ...
        function u(t) {
            ...
            var r = t.selectAll(".handle").data(n.handles,
            function(t) {
                return t.type
            });
            r.exit().remove(),
        ...
        function l() {
            ...
            if (i.apply(this, arguments)) {
                ...
                "overlay" === m ? N.selection = S = [[r = n === bi ? k: z[0], a = n === _i ? T: z[1]], [s = n === bi ? E: r, h = n === _i ? C: a]] : (r = S[0][0], a = S[0][1], s = S[1][0], h = S[1][1]),
                o = r,
                u = a,
                l = s,
                d = h;
                ...
                if (t.event.touches) D.on("touchmove.brush", O, !0).on("touchend.brush touchcancel.brush", B, !0);
                    ...
                    var U = zt(t.event.view).on("keydown.brush",
                    function() {
            ...
            function O() {
                var t = Ot(b); ! P || y || _ || (Math.abs(t[0] - R[0]) > Math.abs(t[1] - R[1]) ? _ = !0 : y = !0),
                R = t,
                g = !0,
                di(),
                Y()
            ...
            function Y() {
                ...
                y && (o = S[0][0], l = S[1][0]),
                _ && (u = S[0][1], d = S[1][1]),
                S[0][0] === o && S[0][1] === u && S[1][0] === l && S[1][1] === d || (N.selection = [[o, u], [l, d]], c.call(b), q.brush())
            }
            function B() {
    ...
    Hi.prototype = ji.prototype = {
        ...
        arc: function(t, n, e, r, i, o) {
            ...
            e && (l < 0 && (l = l % Fi + Fi), l > Ii ? this._ += "A" + e + "," + e + ",0,1," + s + "," + (t - a) + "," + (n - u) + "A" + e + "," + e + ",0,1," + s + "," + (this._x1 = c) + "," + (this._y1 = f) : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(l >= Bi) + "," + s + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))))
        },
    ...
    function co(t, n) {
        for (var e, r = -1,
        i = n.length; ++r < i;) if (e = fo(t, n[r])) return e;
        return 0
    }
    function fo(t, n) {
    ...
    function po() {
        ...
        function o(e, i) {
            ...
            u.forEach(function(t) {
                for (var n, e = 0,
                r = o.length; e < r; ++e) if ( - 1 !== co((n = o[e])[0], t)) return void n.push(t)
            }),
            {
                type: "MultiPolygon",
                value: i,
    ...
    ia.copy = function() {
        var t, n, e = new ea(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
        r = this._root;
        if (!r) return e;
    ...
    ia.visit = function(t) {
        ...
        for (c && u.push(new Jo(c, this._x0, this._y0, this._x1, this._y1)); n = u.pop();) if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && c.length) {
            var f = (r + o) / 2,
            s = (i + a) / 2; (e = c[3]) && u.push(new Jo(e, f, s, o, a)),
    ...
    ia.visitAfter = function(t) {
        ...
        for (this._root && e.push(new Jo(this._root, this._x0, this._y0, this._x1, this._y1)); n = e.pop();) {
            ...
            if (i.length) {
                ...
                f = n.y1,
                s = (a + c) / 2,
                l = (u + f) / 2; (o = i[0]) && e.push(new Jo(o, a, u, s, l)),
    ...
    var wa, Ma = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    function Na(t) {
    ...
    var iu = {
        ...
        FeatureCollection: function(t, n) {
            ...
            r = -1,
            i = e.length; ++r < i;) ru(e[r].geometry, n)
        }
    },
    ou = {
        Sphere: function(t, n) {
        ...
        MultiPolygon: function(t, n) {
            for (var e = t.coordinates,
            r = -1,
            i = e.length; ++r < i;) uu(e[r], n)
        },
        GeometryCollection: function(t, n) {
            for (var e = t.geometries,
            r = -1,
            i = e.length; ++r < i;) ru(e[r], n)
        }
    };
    function au(t, n, e) {
        var r, i = -1,
    ...
    var Tu, Eu, Cu, Pu, zu, Ru, qu, Du, Lu, Uu, Ou, Yu, Bu, Fu, Iu, Hu, ju, Xu, Gu, Vu, $u, Wu, Zu, Qu, Ju, Ku, tc = Ea(),
    nc = {
        point: ec,
        lineStart: ic,
        lineEnd: oc,
    ...
    function Pc(t, n, e, r, i, o) {
        if (e) {
            ...
            for (var f, s = i; r > 0 ? s > o: s < o; s -= c) f = xu([a, -u * ja(s), -u * Wa(s)]),
            t.point(f[0], f[1])
        }
    }
    function zc(t, n) { (n = wu(n))[0] -= t,
        ku(n);
        var e = Ka( - n[1]);
    ...
    function Yc(t, n) {
        ...
        for (var c = 0,
        f = t.length; c < f; ++c) if (l = (s = t[c]).length) for (var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + Ua, v = Wa(p), g = ja(p), y = 0; y < l; ++y, d = b, v = x, g = w, h = _) {
            var _ = s[y],
            b = _[0],
            m = _[1] / 2 + Ua,
            x = Wa(m),
            ...
            if (Oc.add(Ha(k * N * Wa(A), g * w + k * ja(A))), a += S ? M + N * Oa: M, S ^ d >= e ^ b >= e) {
                ...
                var E = Nu(o, T);
                ku(E);
                var C = (S ^ M >= 0 ? -1 : 1) * tu(E[2]); (r > C || r === C && (T[0] || T[1])) && (u += S ^ M >= 0 ? 1 : -1)
            }
        }
        ...
        return function(a) {
            ...
            x = {
                ...
                polygonEnd: function() {
                    ...
                    e = _ && n,
                    i = (c = S(c)).length; (e || i) && (a.polygonStart(), e && (a.lineStart(), o(null, null, 1, a), a.lineEnd()), i && Lc(c, u, n, o, a), a.polygonEnd());
                    b = a,
                    c = f = s = null
                }
            };
    ...
    var uf = {
        ...
        FeatureCollection: function(t, n) {
            for (var e = t.features,
            r = -1,
            i = e.length; ++r < i;) if (ff(e[r].geometry, n)) return ! 0;
            return ! 1
        }
    },
    cf = {
        ...
        MultiPoint: function(t, n) {
            for (var e = t.coordinates,
            r = -1,
            i = e.length; ++r < i;) if (sf(e[r], n)) return ! 0;
            return ! 1
        },
        LineString: function(t, n) {
        ...
        MultiLineString: function(t, n) {
            for (var e = t.coordinates,
            r = -1,
            i = e.length; ++r < i;) if (lf(e[r], n)) return ! 0;
            return ! 1
        },
        Polygon: function(t, n) {
        ...
        MultiPolygon: function(t, n) {
            for (var e = t.coordinates,
            r = -1,
            i = e.length; ++r < i;) if (hf(e[r], n)) return ! 0;
            return ! 1
        },
        GeometryCollection: function(t, n) {
            for (var e = t.geometries,
            r = -1,
            i = e.length; ++r < i;) if (ff(e[r], n)) return ! 0;
            return ! 1
        }
    };
    function ff(t, n) {
        ...
        function(t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, v, g) {
                ...
                if (b > 4 * n && v--) {
                    ...
                    E = k - r,
                    C = T - i,
                    P = _ * E - y * C; (P * P / b > n || Fa((y * E + _ * C) / b - .5) > .3 || a * h + u * d + c * p < Ns) && (e(r, i, o, a, u, c, k, T, A, m /= M, x /= M, w, v, g), g.point(k, T), e(k, T, A, m, x, w, f, s, l, h, d, p, v, g))
                }
            }
            return function(n) {
    ...
    function Es(t) {
        ...
        A.clipExtent = function(t) {
            return arguments.length ? (M = null == t ? (w = r = i = o = null, _f) : Vc(w = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]), T()) : null == w ? null: [[w, r], [i, o]]
        },
        A.scale = function(t) {
    ...
    Ws.invert = function(t, n) {
        ...
        i = r * r,
        o = i * i * i,
        a = 0; a < 12 && (o = (i = (r -= e = (r * (js + Xs * i + o * (Gs + Vs * i)) - n) / (js + 3 * Xs * i + o * (7 * Gs + 9 * Vs * i))) * r) * i * i, !(Fa(e) < qa)); ++a);
    ...
    sl.prototype = al.prototype = {
        ...
        eachAfter: function(t) {
            ...
            o = [i], a = []; i = o.pop();) if (a.push(i), n = i.children) for (e = 0, r = n.length; e < r; ++e) o.push(n[e]);
            for (; i = a.pop();) t(i);
            return this
        },
    ...
    function lh() {
        ...
        return i.domain = function(e) {
            ...
            t = Qi();
            for (var r, o, a = -1,
            u = e.length; ++a < u;) t.has(o = (r = e[a]) + "") || t.set(o, n.push(r));
            return i
        },
        i.range = function(t) {
    ...
    function zh(n) {
        ...
        i.ticks = function(t) {
            var n, i = o(),
            u = i[0],
            c = i[i.length - 1]; (n = c < u) && (h = u, u = c, c = h);
            var f, s, l, h = e(u),
            d = e(c),
            p = null == t ? 10 : +t,
            v = [];
    ...
    k_.prototype = {
        ...
        lineEnd: function() {
            ...
            else for (var r = T_(t), i = T_(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]); (this._line || 0 !== this._line && 1 === e) && this._context.closePath(),
            this._line = 1 - this._line,
            this._x = this._y = null
        },
        point: function(t, n) {
        ...
        if (n && e) {
            ...
            if (r !== o) {
                ...
                if (! (h >= -yb)) {
                    ...
                    t.circle = y;
                    for (var _ = null,
                    b = pb._; b;) if (y.y < b.y || y.y === b.y && y.x <= b.x) {
                        if (!b.L) {
                            _ = b.P;
                            break
                        }
    ...
    function bb(t, n) {
        ...
        for (vb = [], db = new Array(t.length), hb = new B_, pb = new B_;;) if (i = K_, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (fb(o), e = o[0], r = o[1]),
        o = t.pop();
        else {
            if (!i) break;
            cb(i.arc)
        ...
        if (function() {
            for (var t, n, e, r, i = 0,
            o = db.length; i < o; ++i) if ((t = db[i]) && (r = (n = t.halfedges).length)) {
                var a = new Array(r),
                u = new Array(r);
                for (e = 0; e < r; ++e) a[e] = e,
                u[e] = Z_(t, vb[n[e]]);
            ...
            function(t, n, e, r) {
                var i, o, a, u, c, f, s, l, h, d, p, v, g = db.length,
                y = !0;
                for (i = 0; i < g; ++i) if (o = db[i]) {
                    ...
                    l = (s = Q_(o, vb[c[++u % f]]))[0],
                    h = s[1],
                    (Math.abs(p - l) > gb || Math.abs(v - h) > gb) && (c.splice(u, 0, vb.push(G_(a, d, Math.abs(p - t) < gb && r - v > gb ? [t, Math.abs(l - t) < gb ? h: r] : Math.abs(v - r) < gb && e - p > gb ? [Math.abs(h - r) < gb ? l: e, r] : Math.abs(p - e) < gb && v - n > gb ? [e, Math.abs(l - e) < gb ? h: n] : Math.abs(v - n) < gb && p - t > gb ? [Math.abs(h - n) < gb ? l: t, n] : null)) - 1), ++f);
                    f && (y = !1)
                }
                if (y) {
                    var _, b, m, x = 1 / 0;
    ...
    bb.prototype = {
        ...
        triangles: function() {
            ...
            return this.cells.forEach(function(e, r) {
                if (o = (i = e.halfedges).length) for (var i, o, a, u, c, f, s = e.site,
                l = -1,
                h = n[i[o - 1]], d = h.left === s ? h.right: h.left; ++l < o;) a = d,
        ...
        find: function(t, n, e) {
            for (var r, i, o = this,
            a = o._found || 0,
            u = o.cells.length; ! (i = o.cells[a]);) if (++a >= u) return null;
            var c = t - i.site[0],
            f = n - i.site[1],
            s = c * c + f * f;
            do {
    ...
    t.histogram = function() {
        ...
        function r(r) {
            ...
            for (o = 0; o <= d; ++o)(p = v[o] = []).x0 = o > 0 ? h[o - 1] : s,
            p.x1 = o < d ? h[o] : l;
    ...
    t.pairs = function(t, n) {
        ...
        for (var e = 0,
        r = t.length - 1,
        i = t[0], o = new Array(r < 0 ? 0 : r); e < r;) o[e] = n(i, i = t[++e]);
        return o
    },
    ...
    t.chord = function() {
        ...
        function i(i) {
            ...
            for (f = -1; ++f < l;) for (s = f - 1; ++s < l;) {
                var N = _[s * l + f],
                A = _[f * l + s]; (N.value || A.value) && v.push(N.value < A.value ? {
                    source: A,
                    target: N
                }: {
                    source: N,
    ...
    t.nest = function() {
        ...
        function o(e, i, a, u) {
            ...
            for (var c, f, s, l = -1,
            h = e.length,
            d = r[i++], p = Qi(), v = a(); ++l < h;)(s = p.get(c = d(f = e[l]) + "")) ? s.push(f) : p.set(c, [f]);
    ...
    t.drag = function() {
        ...
        function m(n, e, r, i, o) {
            var a, c, h, p = r(e, n),
            v = s.copy();
            if (kt(new Xt(d, "beforestart", a, n, l, p[0], p[1], 0, 0, v),
            function() {
    ...
    t.forceCollide = function(t) {
        ...
        i = 1;
        function o() {
            for (var t, o, u, c, f, s, l, h = n.length,
            d = 0; d < i; ++d) for (o = na(n, oa, aa).visitAfter(a), t = 0; t < h; ++t) u = n[t],
            s = e[u.index],
            l = s * s,
            c = u.x + u.vx,
            f = u.y + u.vy,
    ...
    t.forceLink = function(t) {
        ...
        function s(r) {
            for (var i = 0,
            a = t.length; i < f; ++i) for (var u, c, s, l, h, d, p, v = 0; v < a; ++v) c = (u = t[v]).source,
        ...
        function h() {
            if (r) for (var e = 0,
            i = t.length; e < i; ++e) n[e] = +u(t[e], e, t)
        }
        function d() {
            if (r) for (var n = 0,
    ...
    t.forceManyBody = function() {
        ...
        function l(t, i, c, f) {
            ...
            !0;
            if (! (t.length || d >= a)) { (t.data !== n || t.next) && (0 === s && (d += (s = Zo()) * s), 0 === l && (d += (l = Zo()) * l), d < o && (d = Math.sqrt(o * d)));
                do {
    ...
    t.geoIdentity = function() {
        ...
        return o = {
            ...
            clipExtent: function(r) {
                return arguments.length ? (d = null == r ? (h = t = n = e = null, _f) : Vc(h = +r[0][0], t = +r[0][1], n = +r[1][0], e = +r[1][1]), p()) : null == h ? null: [[h, t], [n, e]]
            },
            scale: function(t) {
    ...
    t.tree = function() {
        ...
        function i(i) {
            var c = function(t) {
                for (var n, e, r, i, o, a = new jl(t, 0), u = [a]; n = u.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) u.push(e = n.children[i] = new jl(r[i], i)),
                e.parent = n;
        ...
        function o(n) {
            ...
            n.parent.A = function(n, e, r) {
                if (e) {
                    ...
                    a = n,
                    u = e,
                    c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = Fl(u), o = Bl(o), u && o;) c = Bl(c),
                    (a = Fl(a)).a = n,
    ...
    t.treemapDice = Rl,
    t.treemapSlice = Xl,
    t.treemapSliceDice = function(t, n, e, r, i) { (1 & t.depth ? Xl: Rl)(t, n, e, r, i)
    },
    t.treemapSquarify = $l,
    ...
    t.scaleQuantile = function t() {
        ...
        c.domain = function(t) {
            ...
            r = [];
            for (var e, i = 0,
            o = t.length; i < o; ++i) null == (e = t[i]) || isNaN(e = +e) || r.push(e);
            return r.sort(n),
            u()
        },
        c.range = function(t) {
    ...
    t.scaleSequentialQuantile = function t() {
        ...
        return o.domain = function(t) {
            ...
            e = [];
            for (var r, i = 0,
            a = t.length; i < a; ++i) null == (r = t[i]) || isNaN(r = +r) || e.push(r);
            return e.sort(n),
            o
        },
    ...
    t.touches = function(t, n) {
        null == n && (n = Lt().touches);
        for (var e = 0,
        r = n ? n.length: 0, i = new Array(r); e < r; ++e) i[e] = Ut(t, n[e]);
        return i
    },
    t.window = ut,
    t.customEvent = kt,
    t.arc = function() {
        ...
        function c() {
            ...
            l > ey && (u.moveTo(l * Qg(p), l * ty(p)), u.arc(0, 0, l, p, d, g));
                ...
                if (S > ey) {
                    var C = ay(S / l * ty(A)),
                    P = ay(S / h * ty(A)); (M -= 2 * C) > ey ? (x += C *= g ? 1 : -1, w -= C) : (M = 0, x = w = (d + p) / 2),
    ...
    t.stackOffsetDiverging = function(t, n) {
        if ((u = t.length) > 1) for (var e, r, i, o, a, u, c = 0,
        f = t[n[0]].length; c < f; ++c) for (o = a = 0, e = 0; e < u; ++e)(i = (r = t[n[e]][c])[1] - r[0]) >= 0 ? (r[0] = o, r[1] = o += i) : i < 0 ? (r[1] = a, r[0] = a += i) : r[0] = o
    },
    ...
    t.zoom = function() {
        ...
        function w(t, n) {
            for (var e, r = 0,
            i = h.length; r < i; ++r) if ((e = h[r]).that === t) return e;
            return new M(t, n)
        }
        function M(t, n) {
            this.that = t,
        ...
        function A() {
            if (!e && r.apply(this, arguments)) {
                ...
                i = zt(t.event.view).on("mousemove.zoom",
                function() {
                    if (Sb(), !n.moved) {
        ...
        function k() {
            if (r.apply(this, arguments)) {
                ...
                f = c.length;
                for (Ab(), i = 0; i < f; ++i) a = [a = Yt(this, c, (o = c[i]).identifier), this.__zoom.invert(a), o.identifier],
        ...
        y.extent = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t: mb([[ + t[0][0], +t[0][1]], [ + t[1][0], +t[1][1]]]), y) : i
        },
