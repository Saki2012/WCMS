...
function() {
    ...
    e.prototype.copyScale = function() {
        ...
        return this.params.isCategory && (t = this.scale.domain(), e.domain([t[0], t[1] - 1])),
        e
    },
    ...
    t.prototype.getYAxis = function(t, e, i, n, r, a, o) {
        var s = this.owner,
        c = s.config,
        d = c["axis_" + t + "_tick_format"]; ! d && s.isAxisNormalized(t) && (d = function(t) {
            return t + "%"
        });
    ...
    t.prototype.updateLabels = function(t) {
        ...
        r = e.main.select("." + Y.axisY2 + " ." + Y.axisY2Label); (t ? i.transition() : i).attr("x", this.xForXAxisLabel.bind(this)).attr("dx", this.dxForXAxisLabel.bind(this)).attr("dy", this.dyForXAxisLabel.bind(this)).text(this.textForXAxisLabel.bind(this)),
    ...
    t.prototype.generateTickValues = function(t, e, i) {
        ...
        if (e) if (1 === (n = h(e) ? e() : e)) l = [t[0]];
        else if (2 === n) l = [t[0], t[t.length - 1]];
        else if (2 < n) {
            for (o = n - 2, r = t[0], s = ((a = t[t.length - 1]) - r) / (1 + o), l = [r], c = 0; c < o; c++) d = +r + s * (c + 1),
    ...
    l.prototype.initWithData = function(t) {
        ...
        n.svg = n.selectChart.append("svg").style("overflow", "hidden").on("mouseenter",
        function() {
    ...
    l.prototype.updateAndRedraw = function(t) {
        var e, i = this,
        n = i.config; (t = t || {}).withTransition = B(t, "withTransition", !0),
    ...
    l.prototype.endall = function(t, e) {
        ...
        function() {--i || e.apply(this, arguments)
        })
    },
    ...
    window.SVGPathSegList.prototype._parsePath = function(t) {
        ...
        i.prototype._parseNumber = function() {
            ...
            if (this._skipOptionalSpaces(), this._currentIndex < this._endIndex && "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++:this._currentIndex < this._endIndex && "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, r = -1), !(this._currentIndex == this._endIndex || (this._string.charAt(this._currentIndex) < "0" || "9" < this._string.charAt(this._currentIndex)) && "." != this._string.charAt(this._currentIndex))) {
                ...
                if (this._currentIndex != s) for (var c = this._currentIndex - 1,
                d = 1; s <= c;) e += d * (this._string.charAt(c--) - "0"),
                d *= 10;
    ...
    n.prototype.flow = function(t) {
        ...
        c.data.targets.forEach(function(t) {
            for (var e, i = !1,
            n = 0; n < r.length; n++) if (t.id === r[n].id) {
        ...
        l ? 1 === l && c.isTimeSeries() && (o = (n.values[n.values.length - 1].x - a.x) / 2, i = [new Date(a.x - o), new Date( + a.x + o)], c.updateXDomain(null, !0, !0, !1, i)) : (o = c.isTimeSeries() ? 1 < n.values.length ? n.values[n.values.length - 1].x - a.x: a.x - c.getXDomain(c.data.targets)[0] : 1, i = [a.x - o, a.x], c.updateXDomain(null, !0, !0, !1, i)),
    ...
    n.prototype.load = function(e) {
        ...
        "cacheIds" in e && t.hasCaches(e.cacheIds) ? t.load(t.getCaches(e.cacheIds), e.done) : e.unload ? t.unload(t.mapToTargetIds(!0 === e.unload ? null: e.unload),
        function() {
            t.loadFromArgs(e)
        }) : t.loadFromArgs(e)
    },
    n.prototype.unload = function(t) {
        var e = this.internal; (t = t || {}) instanceof Array ? t = {
            ids: t
        }: "string" == typeof t && (t = {
            ids: [t]
        }),
        e.unload(e.mapToTargetIds(t.ids),
        function() {
            e.redraw({
                withUpdateOrgXDomain: !0,
                withUpdateXDomain: !0,
    ...
    n.prototype.show = function(t, e) {
        ...
        (i = n.svg.selectAll(n.selectorTargets(t))).transition().style("display", c() ? "block": "initial", "important").style("opacity", 1, "important").call(n.endall,
        function() {
    ...
    n.prototype.hide = function(t, e) {
        ...
        (i = n.svg.selectAll(n.selectorTargets(t))).transition().style("opacity", 0, "important").call(n.endall,
        function() {
    ...
    l.prototype.updateTargetsForArc = function(t) {
        ...
        o = i.select("." + Y.chartArcs).selectAll("." + Y.chartArc).data(e.pie(t)).attr("class",
        function(t) {
            return n(t) + a(t.data)
    ...
    l.prototype.redrawArc = function(t, e, i) {
        ...
        g = h.enter().append("path").attr("class", l.classArc.bind(l)).style("fill",
        function(t) {
        ...
        d && (r = (n = c.selectAll("." + Y.arcs).selectAll("." + Y.arcLabelLine).data(l.arcData.bind(l))).enter().append("rect").attr("class",
        function(t) {
            return Y.arcLabelLine + " " + Y.target + " " + Y.target + "-" + t.data.id
        }).merge(n), 1 === l.filterTargetsToShow(l.data.targets).length ? r.style("display", "none") : r.style("fill",
        function(t) {
        ...
        }).on("mouseover", s.interaction_enabled ?
        function(t) {
            var e, i;
        ...
        }: null).on("mousemove", s.interaction_enabled ?
        function(t) {
            var e, i = l.updateAngle(t);
            i && (e = [l.convertToArcData(i)], l.showTooltip(e, this))
        }: null).on("mouseout", s.interaction_enabled ?
        function(t) {
            var e, i;
        ...
        }: null).on("click", s.interaction_enabled ?
        function(t, e) {
            ...
            l.transiting = !0
        }).transition().duration(t).attrTween("d",
        function(i) {
            var n, t = l.updateAngle(i);
            return t ? (isNaN(this._current.startAngle) && (this._current.startAngle = 0), isNaN(this._current.endAngle) && (this._current.endAngle = this._current.startAngle), n = u.interpolate(this._current, t), this._current = n(0),
            function(t) {
        ...
        }).attr("transform", i ? "scale(1)": "").style("fill",
        function(t) {
            return l.levelColor ? l.levelColor(t.data.values.reduce(function(t, e) {
                return t + e.value
            },
        ...
        c.selectAll("." + Y.chartArc).select("text").style("opacity", 0).attr("class",
        function(t) {
            return l.isGaugeType(t.data) ? Y.gaugeValue: ""
        }).text(l.textForArcLabel.bind(l)).attr("transform", l.transformForArcLabel.bind(l)).style("font-size",
        function(t) {
            return l.isGaugeType(t.data) && 1 === l.filterTargetsToShow(l.data.targets).length ? Math.round(l.radius / 5) + "px": ""
        }).transition().duration(t).style("opacity",
        function(t) {
            return l.isTargetToShow(t.data.id) && l.isArcType(t.data) ? 1 : 0
        }),
        c.select("." + Y.chartArcsTitle).style("opacity", l.hasType("donut") || d ? 1 : 0),
        d && (a = 0, (o = l.arcs.select("g." + Y.chartArcsBackground).selectAll("path." + Y.chartArcsBackground).data(l.data.targets)).enter().append("path").attr("class",
        function(t, e) {
        ...
        (e = i.map(function(o, s) {
            ...
            return {
                ...
                values: t.map(function(t, e) {
                    ...
                    return l.isCustomX() && l.isCategorized() && !w(r) ? (0 === s && 0 === e && (u.axis_x_categories = []), -1 === (i = u.axis_x_categories.indexOf(r)) && (i = u.axis_x_categories.length, u.axis_x_categories.push(r))) : i = l.generateTargetX(r, o, e),
    ...
    l.prototype.getMaxDataCount = function() {
        return this.d3.max(this.data.targets,
        function(t) {
    ...
    l.prototype.hasNegativeValueInTargets = function(t) {
        return this.checkValueInTargets(t,
        function(t) {
            return t < 0
        })
    },
    ...
    l.prototype.findClosestFromTargetsByX = function(t, i) {
        ...
        return t.forEach(function(t) {
            t.values.forEach(function(t) {
                var e = Math.abs(i - t.x); (void 0 === r || e < r) && (n = t, r = e)
            })
        }),
        n
    },
    ...
    l.prototype.loadFromArgs = function(e) {
        var i = this;
        i.resetCache(),
        e.data ? i.load(i.convertDataToTargets(e.data), e) : e.url ? i.convertUrlToData(e.url, e.mimeType, e.headers, e.keys,
        function(t) {
    ...
    l.prototype.getXDomainMin = function(t) {
        var e = this,
        i = e.config;
        return k(i.axis_x_min) ? e.isTimeSeries() ? this.parseDate(i.axis_x_min) : i.axis_x_min: e.d3.min(t,
        function(t) {
            return e.d3.min(t.values,
            function(t) {
                return t.x
            })
        })
    ...
    l.prototype.getXDomainMax = function(t) {
        var e = this,
        i = e.config;
        return k(i.axis_x_max) ? e.isTimeSeries() ? this.parseDate(i.axis_x_max) : i.axis_x_max: e.d3.max(t,
        function(t) {
            return e.d3.max(t.values,
            function(t) {
                return t.x
            })
        })
    ...
    l.prototype.getXDomain = function(t) {
        ...
        o = 0,
        s = 0;
        return n - r != 0 || e.isCategorized() || (r = e.isTimeSeries() ? (n = new Date(.5 * n.getTime()), new Date(1.5 * r.getTime())) : (n = 0 === n ? 1 : .5 * n, 0 === r ? -1 : 1.5 * r)),
    ...
    l.prototype.updateGrid = function(t) {
        ...
        (i = (e = o.select("." + Y.xgridLines).selectAll("." + Y.xgridLine).data(s.grid_x_lines)).enter().append("g").attr("class",
        function(t) {
        ...
        (r = (n = o.select("." + Y.ygridLines).selectAll("." + Y.ygridLine).data(s.grid_y_lines)).enter().append("g").attr("class",
        function(t) {
    ...
    l.prototype.getGridFilterToRemove = function(t) {
        ...
        function(e) {
            var i = !1;
            return [].concat(t).forEach(function(t) { ("value" in t && e.value === t.value || "class" in t && e.class === t.class) && (i = !0)
            }),
            i
        }: function() {
            return ! 0
    ...
    l.prototype.redrawEventRect = function() {
        ...
        s.eventRect.attr("x", 0).attr("y", 0).attr("width", s.width).attr("height", s.height).on("mouseout", d.interaction_enabled ?
        function() {
            d && (s.hasArcType() || (s.mouseover && (d.data_onmouseout.call(s.api, s.mouseover), s.mouseover = void 0), l()))
        }: null).on("mousemove", d.interaction_enabled ?
        function() {
            if (!s.dragging) {
        ...
        }: null).on("click", d.interaction_enabled ?
        function() {
            ...
            s.hasArcType(n) || (t = c.mouse(this), e = h(s.findClosestFromTargets(n, t)), u(t, e) && ((!d.data_selection_grouped || s.isStanfordType(e) ? [e] : s.filterByX(n, e.x)).forEach(function(t) {
                s.main.selectAll("." + Y.shapes + s.getTargetSelectorSuffix(t.id)).selectAll("." + Y.shape + "-" + t.index).each(function() { (d.data_selection_grouped || s.isWithinShape(this, t)) && s.toggleShape(this, t, t.index)
                })
            }), e && (i = s.main.selectAll("." + Y.shapes + s.getTargetSelectorSuffix(e.id)).select("." + Y.shape + "-" + e.index), d.data_onclick.call(s.api, e, i.node()))))
        }: null).call(d.interaction_enabled && d.data_selection_draggable && s.drag ? c.drag().on("drag",
        function() {
            s.drag(c.mouse(this))
        }).on("start",
        function() {
    ...
    l.prototype.transformLegend = function(t) { (t ? this.legend.transition() : this.legend).attr("transform", this.getTranslate("legend"))
    },
    ...
    l.prototype.toggleFocusLegend = function(e, t) {
        ...
        }).classed(Y.legendItemFocused, t).transition().duration(100).style("opacity",
        function() {
    ...
    l.prototype.revertLegend = function() {
        var t = this,
        e = t.d3;
        t.legend.selectAll("." + Y.legendItem).classed(Y.legendItemFocused, !1).transition().duration(100).style("opacity",
        function() {
    ...
    l.prototype.showLegend = function(t) {
        ...
        e.legend.selectAll(e.selectorLegends(t)).style("visibility", "visible").transition().style("opacity",
        function() {
    ...
    l.prototype.updateLegend = function(f, t, e) {
        ...
        (u = m.legend.selectAll("." + Y.legendItem).data(f).enter().append("g").attr("class",
        function(t) {
        ...
        }).on("click", S.interaction_enabled ?
        function(t) {
        ...
        }: null).on("mouseover", S.interaction_enabled ?
        function(t) {
        ...
        (h ? x.transition() : x).style("stroke", m.levelColor ?
        function(t) {
        ...
        m.legend.selectAll("." + Y.legendItem).classed(Y.legendItemHidden,
        function(t) {
    ...
    l.prototype.updateRegion = function(t) {
        ...
        r = n.enter().append("g");
        r.append("rect").attr("x", e.regionX.bind(e)).attr("y", e.regionY.bind(e)).attr("width", e.regionWidth.bind(e)).attr("height", e.regionHeight.bind(e)).style("fill-opacity",
        function(t) {
    ...
    l.prototype.redrawRegion = function(t, e) {
        ...
        return [(t ? n.transition(e) : n).attr("x", i.regionX.bind(i)).attr("y", i.regionY.bind(i)).attr("width", i.regionWidth.bind(i)).attr("height", i.regionHeight.bind(i)).style("fill-opacity",
        function(t) {
            return C(t.opacity) ? t.opacity: .1
    ...
    l.prototype.updateScales = function() {
        ...
        e.x = e.getX(e.xMin, e.xMax, i ? void 0 : e.x.orgDomain(),
        function() {
        ...
        e.subX = e.getX(e.xMin, e.xMax, e.orgXDomain,
        function(t) {
    ...
    l.prototype.selectPoint = function(t, e, i) {
        ...
        n.main.select("." + Y.selectedCircles + n.getTargetSelectorSuffix(e.id)).selectAll("." + Y.selectedCircle + "-" + i).data([e]).enter().append("circle").attr("class",
        function() {
            return n.generateClass(Y.selectedCircle, i)
        }).attr("cx", a).attr("cy", o).attr("stroke",
        function() {
            return n.color(e)
        }).attr("r",
        function(t) {
    ...
    l.prototype.selectPath = function(t, e) {
        ...
        i.config.interaction_brighten && t.transition().duration(100).style("fill",
        function() {
    ...
    l.prototype.getToggle = function(t, e) {
        var i;
        return "circle" === t.nodeName ? i = this.isStepType(e) ?
        function() {}: this.togglePoint: "path" === t.nodeName && (i = this.togglePath),
        i
    },
    ...
    l.prototype.updateTargetsForBar = function(t) {
        ...
        a = e.classFocus.bind(e);
        e.main.select("." + Y.chartBars).selectAll("." + Y.chartBar).data(t).attr("class",
        function(t) {
            return n(t) + a(t)
        }).enter().append("g").attr("class", n).style("pointer-events", "none").append("g").attr("class", r).style("cursor",
        function(t) {
    ...
    l.prototype.redrawBar = function(t, e, i) {
        var n = this;
        return [(e ? this.mainBar.transition(i) : this.mainBar).attr("d", t).style("stroke", this.color).style("fill", this.color).style("opacity",
        function(t) {
    ...
    l.prototype.getShapeOffset = function(t, d, e) {
        ...
        return function(r, a) {
            ...
            return i.forEach(function(t) {
                ...
                t.id !== r.id && d[t.id] === d[r.id] && u.indexOf(t.id) < u.indexOf(r.id) && (!w(e[a]) && +e[a].x == +r.x || (a = -1, e.forEach(function(t, e) { (t.x.constructor === Date ? +t.x: t.x) === (r.x.constructor === Date ? +r.x: r.x) && (a = e)
    ...
    l.prototype.updateTargetsForLine = function(t) {
        ...
        c = i.main.select("." + Y.chartLines).selectAll("." + Y.chartLine).data(t).attr("class",
        function(t) {
            return n(t) + s(t)
        ...
        c.append("g").attr("class", o).style("cursor",
        function(t) {
    ...
    l.prototype.updateLine = function(t) {
        ...
        e.mainLine = n.merge(i).style("opacity", e.initialOpacity.bind(e)).style("shape-rendering",
        function(t) {
    ...
    l.prototype.updateArea = function(t) {
        ...
        r = n.enter().append("path").attr("class", e.classArea.bind(e)).style("fill", e.color).style("opacity",
        function() {
    ...
    l.prototype.initBrush = function(t) {
        var r = this,
        e = r.d3;
        return r.brush = (r.config.axis_rotated ? e.brushY() : e.brushX()).on("brush",
        function() {
    ...
    l.prototype.redrawBarForSubchart = function(t, e, i) { (e ? this.contextBar.transition(Math.random().toString()).duration(i) : this.contextBar).attr("d", t).style("opacity", 1)
    },
    ...
    l.prototype.redrawLineForSubchart = function(t, e, i) { (e ? this.contextLine.transition(Math.random().toString()).duration(i) : this.contextLine).attr("d", t).style("opacity", 1)
    },
    ...
    l.prototype.redrawAreaForSubchart = function(t, e, i) { (e ? this.contextArea.transition(Math.random().toString()).duration(i) : this.contextArea).attr("d", t).style("fill", this.color).style("opacity", this.orgAreaOpacity)
    },
    ...
    l.prototype.updateText = function(t, e, i) {
        ...
        c = s.enter().append("text").attr("class", o).attr("text-anchor",
        function(t) {
            return r.axis_rotated ? t.value < 0 ? "end": "start": "middle"
        }).style("stroke", "none").attr("x", t).attr("y", e).style("fill",
        function(t) {
            return n.color(t)
    ...
    l.prototype.getYForText = function(t, e, i) {
        var n, r = this,
        a = d(i);
        return r.config.axis_rotated ? n = (t[0][0] + t[2][0] + .6 * a.height) / 2 : (n = t[2][1], e.value < 0 || 0 === e.value && !r.hasPositiveValue ? (n += a.height, r.isBarType(e) && r.isSafari() ? n -= 3 : !r.isBarType(e) && r.isChrome() && (n += 3)) : n += r.isBarType(e) ? -3 : -6),
    ...
    l.prototype.drawColorScale = function() {
        ...
        o.colorScale.append("g").attr("transform", "translate(0, " + c.stanford_padding.top + ")").selectAll("bars").data(e).enter().append("rect").attr("y",
        function(t, e) {
            return 5 * e
        }).attr("x", 0).attr("width", l).attr("height", 5).attr("fill",
        function(t) {
            return r(t)
        }),
    ...
    var y = function(t) {
        for (var e, i, n = 0,
        r = 0,
        a = t.length - 1; r < t.length; a = r, r += 1) e = t[r],
        i = t[a],
        n += e.x * i.y,
        n -= e.y * i.x;
        return n /= 2
    ...
    S = function(t, e) {
        for (var i, n, r, a, o = t.x,
        s = t.value,
        c = !1,
        d = 0,
        l = e.length - 1; d < e.length; l = d++) i = e[d].x,
        n = e[d].y,
        a = e[l].x,
    ...
    l.prototype.updateStanfordElements = function(t) {
        ...
        h = u.enter().append("g").attr("class",
        function(t) {
            return Y.stanfordLine + (t.class ? " " + t.class: "")
        });
        h.append("line").attr("x1",
        function(t) {
        ...
        a.stanfordLines.select("line").transition().duration(t).attr("x1",
        function(t) {
            return s.axis_rotated ? d(t, "value_y1") : c(t, "value_x1")
        }).attr("x2",
        function(t) {
        ...
        (r = (n = o.select("." + Y.stanfordTexts).selectAll("." + Y.stanfordText).data(s.stanford_texts)).enter().append("g").attr("class",
        function(t) {
        ...
        a.stanfordTexts.select("text").transition().duration(t).attr("x",
        function(t) {
            return s.axis_rotated ? d(t, "y") : c(t, "x")
        }).attr("y",
        function(t) {
        ...
        n.exit().transition().duration(t).style("opacity", 0).remove(),
        (i = (e = o.select("." + Y.stanfordRegions).selectAll("." + Y.stanfordRegion).data(s.stanford_regions)).enter().append("g").attr("class",
        function(t) {
        ...
        a.stanfordRegions.select("polygon").transition().duration(t).attr("points",
        function(t) {
            return t.points.map(function(t) {
                return [s.axis_rotated ? d(t, "y") : c(t, "x"), s.axis_rotated ? c(t, "x") : d(t, "y")].join(",")
            }).join(" ")
        ...
        a.stanfordRegions.select("text").transition().duration(t).attr("x",
        function(t) {
    ...
    l.prototype.getTooltipContent = function(t, e, i, n) {
        ...
        g = u.tooltip_format_name ||
        function(t) {
            return t
        },
        p = (p = u.tooltip_format_value) || (l.isTargetNormalized(t.id) ?
        function(t, e) {
    ...
    l.prototype.hasType = function(i, t) {
        ...
        return (t = t || this.data.targets) && t.length ? t.forEach(function(t) {
            var e = n[t.id]; (e && 0 <= e.indexOf(i) || !e && "line" === i) && (r = !0)
    ...
    l.prototype.initDragZoom = function() {
        ...
        t = i.dragZoomBrush = n.brushX().on("start",
        function() {
            i.api.unzoom(),
