                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 p-0">
                                                        <ul className="list">
                                                            ...
                                                            <li>
                                                                <a href="#" onClick={(e) => { e.preventDefault(); }} tabIndex={5} title="">研究發展處 Facebook</a>
                                                            </li>
                                                            <li>
                                                                <a href="#" onClick={(e) => { e.preventDefault(); }} tabIndex={5} title="">研究發展處 Youtube</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                ...
                <div className="container-customize1">
                    <div className="col-12">
                        <div className="row mx-0">
                            ...
                            <SiteInfo  items={[mock_SiteInfoData()[0]]} displays={mock_SiteInfoData()[1]}></SiteInfo>
                        </div>
                    </div>
                </div>
            </section>
