...
const SubContent = ({style}:{style:IFETheme}) => {
  //#region  FakeData
            ...
            <div className="row">
              ...
              <div className="col-md-12 w-100">
                <nav className="custom_breadcrumb" aria-label="breadcrumb">
                  <BreadCrumbComp items={breadCrumbData} style={style.BreadCrumb} isUl={false} externalDOM={back}></BreadCrumbComp>
                </nav>
              </div>
              {/* SideMenu區塊 */}
              <div className="col-lg-2 col-md-12 col-sm-12 col-12">
                  <div id="ContentPlaceContent_ContentSubMenu" className="col-sm-12 col-12 px-0 page-leftmenu">
                      ...
                      <nav className="Left-Second-navBox">
                        <MenuListComp items={menuData} Style={style.SideMenu}></MenuListComp>
                      </nav>
                  </div>
              </div>
              {/* 主內容區塊 */}
