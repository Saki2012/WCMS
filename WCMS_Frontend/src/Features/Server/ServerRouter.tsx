            ...
            children: [
              ...
              //#region 公告
              {
                ...
                children: [
                  ...
                  { path: 'Category/:internalId?', element: <CategoryListComp progId="Announcement" title="類別" theme={Classic_BETheme} /> },
                  { path: 'Tag/:internalId?', element: <TagListComp progId="Announcement" title="標籤" theme={Classic_BETheme} /> },
                ],
              },
              //#endregion
              //#region 頁面
              {
                ...
                children: [
                  ...
                  { path: 'Category/:internalId?', element: <CategoryListComp progId="PageManagement" title="類別" theme={Classic_BETheme} /> },
                ],
              },
              //#endregion
              //#region 相簿
              {
                ...
                children: [
                  ...
                  { path: 'Category/:internalId?', element: <CategoryListComp progId="Gallery" title="類別" theme={Classic_BETheme} /> },
                  { path: 'Tag/:internalId?', element: <TagListComp progId="Gallery" title="標籤" theme={Classic_BETheme} /> },
                ],
              },
              //#endregion
              //#region 檔案室
              {
                ...
                children: [
                  ...
                  { path: 'Category/:internalId?', element: <CategoryListComp progId="FileManage" title="類別" theme={Classic_BETheme} /> },
                  { path: 'Tag/:internalId?', element: <TagListComp progId="FileManage" title="標籤" theme={Classic_BETheme} /> },
                ],
              },
              //#endregion
              //#region 網路資源
              {
                ...
                children: [
                  ...
                  { path: 'Category/:internalId?', element: <CategoryListComp progId="WebResource" title="類別" theme={Classic_BETheme} /> },
                  { path: 'Tag/:internalId?', element: <TagListComp progId="WebResource" title="標籤" theme={Classic_BETheme} /> },
                ],
              },
              //#endregion
              //#region 研究計劃
              {
                ...
                children: [
                  ...
                  { path: 'Category/:internalId?', element: <CategoryListComp progId="SpecResearch" title="類別" theme={Classic_BETheme} /> },
                  { path: 'Tag/:internalId?', element: <TagListComp progId="SpecResearch" title="標籤" theme={Classic_BETheme} /> },
                ],
              },
              //#endregion
              //#region USR
              {
                ...
                children: [
                  ...
                  { path: 'Category/:internalId?', element: <CategoryListComp progId="SpecUSR" title="類別" theme={Classic_BETheme} /> },
                  { path: 'Tag/:internalId?', element: <TagListComp progId="SpecUSR" title="標籤" theme={Classic_BETheme} /> },
                ],
              },
              //#endregion
            ],
