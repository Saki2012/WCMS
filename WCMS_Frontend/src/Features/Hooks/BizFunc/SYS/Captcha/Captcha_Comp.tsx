...
export type CaptchaTurnstileOption = Pick<CaptchaTurnstileProps, "action" | "cData" | "theme" | "size" | "tabIndex" | "language" | "nonce">;
...
export const Captcha_Comp = (props: CaptchaCompProps) =>
{
    ...
    return (
        <fieldset ref={props.captcha.rootRef} className={props.className ?? "mb-3"} tabIndex={-1} aria-labelledby={titleId} aria-describedby={describedBy} aria-invalid={Boolean(errorText)}>
