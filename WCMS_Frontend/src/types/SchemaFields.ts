...
export const AccountSetFields = { Account: "Account" } as const;

export type AccountSetFieldKey = keyof typeof AccountSetFields;

export const AccountSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const AnnouncementSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const BannerSetFields = { Banner: "Banner", BannerDetail: "BannerDetail", BannerDetailInfo: "BannerDetailInfo" } as const;

export type BannerSetFieldKey = keyof typeof BannerSetFields;

export const BannerSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const CalendarSetFields = { Calendar: "Calendar", CalendarDetail: "CalendarDetail" } as const;

export type CalendarSetFieldKey = keyof typeof CalendarSetFields;

export const CalendarSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const CategoryDataSetFields = { Category: "Category", CategoryDetail: "CategoryDetail" } as const;

export type CategoryDataSetFieldKey = keyof typeof CategoryDataSetFields;

export const CategoryDataSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;

export type CategoryDataSet_DTOApiRequestFieldKey = keyof typeof CategoryDataSet_DTOApiRequestFields;

export const CategoryDetailFields = { CategoryId: "CategoryId", RowId: "RowId", Lang: "Lang", CategoryName: "CategoryName" } as const;
...
export const ChangePasswordFields = { OldPassword: "OldPassword", NewPassword: "NewPassword" } as const;
...
export const FileArchiveSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const FileManageSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const GalleryInfoFields = { GalleryId: "GalleryId", RowId: "RowId", Lang: "Lang", Title: "Title", Content: "Content" } as const;

export type GalleryInfoFieldKey = keyof typeof GalleryInfoFields;

export const GalleryPhotosInfoFields = { GalleryId: "GalleryId", ParentRowId: "ParentRowId", RowId: "RowId", Lang: "Lang", Title: "Title" } as const;
...
export const GallerySet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const LoginDtoFields = { Account: "Account", Password: "Password" } as const;
...
export const MatCategoryDataSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const MaterialSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;

export type MaterialSet_DTOApiRequestFieldKey = keyof typeof MaterialSet_DTOApiRequestFields;

export const MaterialTagsFields = { MaterialId: "MaterialId", RowId: "RowId", Tag: "Tag", TagId: "TagId", _Material: "_Material" } as const;
...
export const ORCIDDataApiResponseFields = { IsSuccess: "IsSuccess", SysMessage: "SysMessage", Data: "Data" } as const;

export type ORCIDDataApiResponseFieldKey = keyof typeof ORCIDDataApiResponseFields;

export const OrderBySpecFields = { Col: "Col", Desc: "Desc" } as const;

export type OrderBySpecFieldKey = keyof typeof OrderBySpecFields;

export const PageManagementDetailFields = { PageId: "PageId", RowId: "RowId", Lang: "Lang", Title: "Title", Content: "Content" } as const;

export type PageManagementDetailFieldKey = keyof typeof PageManagementDetailFields;

export const PageManagementSetFields = { PageManagement: "PageManagement", PageManagementDetail: "PageManagementDetail" } as const;

export type PageManagementSetFieldKey = keyof typeof PageManagementSetFields;

export const PageManagementSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const PermissionCatalogModuleDTOFields = { ModuleCode: "ModuleCode", ModuleTitle: "ModuleTitle", Progs: "Progs" } as const;

export type PermissionCatalogModuleDTOFieldKey = keyof typeof PermissionCatalogModuleDTOFields;

export const PermissionCatalogModuleDTOApiResponseFields = { IsSuccess: "IsSuccess", SysMessage: "SysMessage", Data: "Data" } as const;

export type PermissionCatalogModuleDTOApiResponseFieldKey = keyof typeof PermissionCatalogModuleDTOApiResponseFields;

export const PermissionCatalogProgDTOFields = { ProgId: "ProgId", ProgTitle: "ProgTitle", SupportMask: "SupportMask" } as const;
...
export const PersonSetFields = { Person: "Person" } as const;

export type PersonSetFieldKey = keyof typeof PersonSetFields;

export const PersonSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;

export type PersonSet_DTOApiRequestFieldKey = keyof typeof PersonSet_DTOApiRequestFields;

export const PublishReqFields = { InternalId: "InternalId", JournalIndexId: "JournalIndexId", JournalIndexRowId: "JournalIndexRowId" } as const;
...
export const RankGroupsSpecFields = { Condition: "Condition", OrderBy: "OrderBy" } as const;

export type RankGroupsSpecFieldKey = keyof typeof RankGroupsSpecFields;

export const ResetPasswordFields = { UserInternalId: "UserInternalId", NewPassword: "NewPassword" } as const;
...
export const RolePermissionSetFields = { RoleData: "RoleData", RolePermission: "RolePermission" } as const;

export type RolePermissionSetFieldKey = keyof typeof RolePermissionSetFields;

export const RolePermissionSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;

export type RolePermissionSet_DTOApiRequestFieldKey = keyof typeof RolePermissionSet_DTOApiRequestFields;

export const SaveMenuItemModuleFields = { BannerId: "BannerId", PageType: "PageType", ModuleProgId: "ModuleProgId", ModuleOptions: "ModuleOptions" } as const;

export type SaveMenuItemModuleFieldKey = keyof typeof SaveMenuItemModuleFields;

export const SaveMenuItemResultFields = { RowId: "RowId", FullUrl: "FullUrl", IsNewItem: "IsNewItem" } as const;

export type SaveMenuItemResultFieldKey = keyof typeof SaveMenuItemResultFields;

export const SaveMenuItemResult_DTOApiResponseFields = { IsSuccess: "IsSuccess", SysMessage: "SysMessage", Data: "Data" } as const;

export type SaveMenuItemResult_DTOApiResponseFieldKey = keyof typeof SaveMenuItemResult_DTOApiResponseFields;

export const SaveMenuItemTitleFields = { RowId: "RowId", Lang: "Lang", Title: "Title", IsShowOnMenu: "IsShowOnMenu" } as const;

export type SaveMenuItemTitleFieldKey = keyof typeof SaveMenuItemTitleFields;

export const SaveMenuItemUrlFields = { RedirectType: "RedirectType", RedirectUrl: "RedirectUrl" } as const;
...
export const SaveMenuItem_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;

export type SaveMenuItem_DTOApiRequestFieldKey = keyof typeof SaveMenuItem_DTOApiRequestFields;

export const SaveMenuStructureItemFields = { RowId: "RowId", ParentRowId: "ParentRowId", DisplayOrder: "DisplayOrder" } as const;

export type SaveMenuStructureItemFieldKey = keyof typeof SaveMenuStructureItemFields;

export const SaveMenuStructureFields = { InternalId: "InternalId", Items: "Items", DeletedRowIds: "DeletedRowIds" } as const;

export type SaveMenuStructureFieldKey = keyof typeof SaveMenuStructureFields;

export const SaveMenuStructure_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;

export type SaveMenuStructure_DTOApiRequestFieldKey = keyof typeof SaveMenuStructure_DTOApiRequestFields;

export const SaveSiteInfoFields = { InternalId: "InternalId", SiteMenu_Index: "SiteMenu_Index", SiteMenu_IndexInfo: "SiteMenu_IndexInfo" } as const;

export type SaveSiteInfoFieldKey = keyof typeof SaveSiteInfoFields;

export const SaveSiteInfo_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SiteMenuSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SiteViewCountSet_DTOApiResponseFields = { IsSuccess: "IsSuccess", SysMessage: "SysMessage", Data: "Data" } as const;

export type SiteViewCountSet_DTOApiResponseFieldKey = keyof typeof SiteViewCountSet_DTOApiResponseFields;

export const SpecCategoryDetailModelFields = { CategoryId: "CategoryId", RowId: "RowId", Lang: "Lang", CategoryName: "CategoryName" } as const;
...
export const SpecCategorySetFields = { SpecCategory: "SpecCategory", SpecCategoryDetail: "SpecCategoryDetail" } as const;

export type SpecCategorySetFieldKey = keyof typeof SpecCategorySetFields;

export const SpecCategorySet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SpecCurrentOpenTime_DTOApiResponseFields = { IsSuccess: "IsSuccess", SysMessage: "SysMessage", Data: "Data" } as const;
...
export const SpecHomePage1820Set_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SpecHomePageWeather_DTOApiResponseFields = { IsSuccess: "IsSuccess", SysMessage: "SysMessage", Data: "Data" } as const;
...
export const SpecJournalIndexSetFields = { SpecJournalIndex: "SpecJournalIndex", SpecJournalIndexDetail: "SpecJournalIndexDetail" } as const;

export type SpecJournalIndexSetFieldKey = keyof typeof SpecJournalIndexSetFields;

export const SpecJournalIndexSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SpecJournalSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SpecMusicalSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SpecOpenScheduleRuleSetFields = { SpecOpenScheduleRule: "SpecOpenScheduleRule" } as const;

export type SpecOpenScheduleRuleSetFieldKey = keyof typeof SpecOpenScheduleRuleSetFields;

export const SpecOpenScheduleRuleSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SpecResearchSetFields = { SpecResearch: "SpecResearch", SpecResearchDetail: "SpecResearchDetail" } as const;

export type SpecResearchSetFieldKey = keyof typeof SpecResearchSetFields;

export const SpecResearchSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SpecUSRSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const SysMessageModelFields = { Status: "Status", MessageCode: "MessageCode", Message: "Message" } as const;
...
export const TagDetailFields = { TagId: "TagId", RowId: "RowId", Lang: "Lang", TagName: "TagName" } as const;

export type TagDetailFieldKey = keyof typeof TagDetailFields;

export const TagSetFields = { TagData: "TagData", TagDetail: "TagDetail" } as const;

export type TagSetFieldKey = keyof typeof TagSetFields;

export const TagSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const TimelineSetFields = { Timeline: "Timeline", TimelineItem: "TimelineItem", TimelineLangDetail: "TimelineLangDetail" } as const;

export type TimelineSetFieldKey = keyof typeof TimelineSetFields;

export const TimelineSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
...
export const TryCountDetailViewRequestFields = { SiteIndex: "SiteIndex", ProgId: "ProgId", InternalId: "InternalId" } as const;

export type TryCountDetailViewRequestFieldKey = keyof typeof TryCountDetailViewRequestFields;

export const TryCountResultFields = { IsCounted: "IsCounted", CurrentCount: "CurrentCount" } as const;

export type TryCountResultFieldKey = keyof typeof TryCountResultFields;

export const TryCountResult_DTOApiResponseFields = { IsSuccess: "IsSuccess", SysMessage: "SysMessage", Data: "Data" } as const;

export type TryCountResult_DTOApiResponseFieldKey = keyof typeof TryCountResult_DTOApiResponseFields;

export const TryCountSiteViewRequestFields = { SiteIndex: "SiteIndex" } as const;
...
export const WebResourceSetFields = { WebResource: "WebResource", WebResourceInfo: "WebResourceInfo" } as const;

export type WebResourceSetFieldKey = keyof typeof WebResourceSetFields;

export const WebResourceSet_DTOApiRequestFields = { InternalId: "InternalId", Data: "Data" } as const;
