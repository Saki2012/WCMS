...
export const SpecMusicalFields = {
  InternalId: 'InternalId',
  CreateTime: 'CreateTime',
  CreateUser: 'CreateUser',
  CreateUserId: 'CreateUserId',
...
export type SpecMusicalFieldKey = keyof typeof SpecMusicalFields;

export const SpecMusicalApiRequestFields = {
  InternalId: 'InternalId',
  Data: 'Data',
} as const;

export type SpecMusicalApiRequestFieldKey = keyof typeof SpecMusicalApiRequestFields;
