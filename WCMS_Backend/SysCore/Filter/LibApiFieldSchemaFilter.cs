...
/// </summary>
public sealed class LibApiFieldSchemaFilter : ISchemaFilter
{
    #region Property
    ...
    /// </summary>
    public LibApiFieldSchemaFilter(IOptions<JsonOptions>? jsonOptions = null)
    {
        _jsonOptions = jsonOptions?.Value.JsonSerializerOptions ?? new JsonSerializerOptions(JsonSerializerDefaults.Web);
    }
    ...
    public void Apply(OpenApiSchema schema, SchemaFilterContext context)
    {
        ...
        {
            ApplyPropertyPolicy(schema, property);
        }
    }
    #endregion
    ...
    {
        foreach (var name in GetJsonPropertyNameCandidates(property))
        {
