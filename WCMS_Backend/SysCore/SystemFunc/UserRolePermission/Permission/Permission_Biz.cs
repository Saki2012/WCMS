...
{
    public class PermissionBiz(IRepositoryMapProvider repoMapProvider, IErrorHelper message) : BizService<PermissionSet>(repoMapProvider, message), IBizService<PermissionSet>
    {
        #region Public
