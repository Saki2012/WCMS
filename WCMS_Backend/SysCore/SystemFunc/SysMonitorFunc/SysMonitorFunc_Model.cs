...
namespace WCMS.SysCore.SystemFunc.SysMonitorFunc
{
    /// <summary>
    /// 前後端 / 主機資源快照
    /// 注:
    ...
    public class SystemMonitorSnapshotModel
    {
        ...
        /// 站台代碼
        /// </summary>
        [Required, StringLength(SysLengthParam.ID)] public string SiteCode { get; set; } = string.Empty;
        /// <summary>
        /// 環境代碼(Dev/Staging/Prod)
        /// </summary>
        [StringLength(SysLengthParam.Info)] public string EnvironmentCode { get; set; } = string.Empty;
        /// <summary>
        /// 機器名稱
        /// </summary>
        [Required, StringLength(SysLengthParam.Name)] public string MachineName { get; set; } = string.Empty;
        /// <summary>
        /// 節點實例代碼
        /// 例: wcms-1810-fe-01 / wcms-1810-be-01
        /// </summary>
        [Required, StringLength(SysLengthParam.Title)] public string InstanceId { get; set; } = string.Empty;
        /// <summary>
        /// 節點角色
        /// </summary>
        public EndType NodeRole { get; set; }
        /// <summary>
        /// 快照時間
        /// </summary>
        ...
        /// 系統槽代號(通常為 C)
        /// </summary>
        [StringLength(SysLengthParam.Info)] public string SystemDriveName { get; set; } = string.Empty;
        /// <summary>
        /// 系統槽總容量(GB)
        /// </summary>
        ...
        /// 應用槽代號(通常為 F，可為空)
        /// </summary>
        [StringLength(SysLengthParam.Info)] public string AppDriveName { get; set; } = string.Empty;
        /// <summary>
        /// 應用槽總容量(GB)
        /// </summary>
        ...
        /// 健康摘要訊息
        /// </summary>
        [StringLength(SysLengthParam.Memo)]
    ...
    public class DependencyMonitorSnapshotModel
    {
        ...
        /// 站台代碼
        /// </summary>
        [Required, StringLength(SysLengthParam.ID)]
        ...
        /// 收集來源實例代碼
        /// </summary>
        [Required, StringLength(SysLengthParam.Title)] public string CollectorInstanceId { get; set; } = string.Empty;
        /// <summary>
        /// 依賴類型
        /// </summary>
        ...
        /// </summary>
        [Required, StringLength(SysLengthParam.ID)] public string TargetCode { get; set; } = string.Empty;
        /// <summary>
        /// 顯示名稱
        /// </summary>
        [StringLength(SysLengthParam.Title)] public string TargetName { get; set; } = string.Empty;
        /// <summary>
        /// 目標主機或網址
        /// </summary>
        [StringLength(SysLengthParam.Url)] public string TargetHost { get; set; } = string.Empty;
        /// <summary>
        /// 目標連接埠
        /// </summary>
        ...
        /// 錯誤或摘要訊息
        /// </summary>
        [StringLength(SysLengthParam.Memo)] public string Message { get; set; } = string.Empty;
        /// <summary>
        /// DB 資料檔大小(MB)
        /// </summary>
