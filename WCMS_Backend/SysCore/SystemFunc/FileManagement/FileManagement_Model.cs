...
public override string InternalId { get; set; }= Guid.NewGuid().ToString();
    ...
    /// 路徑
    /// </summary>
[StringLength(SysLengthParam.Path)]
[LibField(ApiFieldMode.ReadWrite)]
public string Path { get; set; } = string.Empty;
    /// <summary>
    /// 檔案名稱
    /// </summary>
[StringLength(SysLengthParam.FileName)]
[LibField(ApiFieldMode.ReadWrite)]
public string FileName { get; set; } = string.Empty;
    /// <summary>
    /// 副檔名
    /// </summary>
[StringLength(SysLengthParam.FileExt)]
[LibField(ApiFieldMode.ReadWrite)]
...
public string FileDescription { get; set; }= string.Empty;
    ...
    /// 網際網路媒體型式
    /// </summary>
[StringLength(SysLengthParam.FileMineType)]
[LibField(ApiFieldMode.ReadWrite)]
public string MimeType { get; set; }= string.Empty;
    ...
    /// </summary>
[StringLength(SysLengthParam.FileSHA256)]
[LibField(ApiFieldMode.ReadWrite)]
...
public long FileSize { get; set; }
    ...
    /// 功能Id
    /// </summary>
[StringLength(SysLengthParam.ProgId)]
[LibField(ApiFieldMode.ReadWrite)]
...
public FileStatus FileStatus { get; set; }= FileStatus.None;
    ...
    /// 來源IP
    /// </summary>
[StringLength(SysLengthParam.IP)]
[LibField(ApiFieldMode.ReadWrite)]
public string SrcIP { get; set; }= string.Empty;
    /// <summary>
    /// 來源機器
    /// </summary>
[StringLength(SysLengthParam.Name)]
[LibField(ApiFieldMode.ReadWrite)]
...
public string ErrorCode { get; set; }= string.Empty;
    ...
    /// 錯誤訊息
    /// </summary>
[StringLength(SysLengthParam.CodeMessage)]
[LibField(ApiFieldMode.ReadWrite)]
