...
public abstract class HeaderModel : DbModel
{
    ...
    /// 系統內部唯一標識號
    /// </summary>
    [LibStr(ApiFieldMode.ReadOnly, SysLengthParam.InternalId, DisplayName.Common_InternalId)]
    ...
    [LibStr(ApiFieldMode.ReadOnly, SysLengthParam.ID, DisplayName.Common_CreateUserId, DisplayName.CreateUserName)]
