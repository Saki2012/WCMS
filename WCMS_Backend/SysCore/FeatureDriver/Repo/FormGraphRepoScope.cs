...
/// </summary>
public class FormGraphRepoScope<TFormModel>  where TFormModel : class
{
    #region Property
    private readonly DbRepositoryProvider _dbRepositoryProvider;
    ...
    /// </summary>
    public FormGraphRepoScope(DbRepositoryProvider dbRepositoryProvider)
    {
