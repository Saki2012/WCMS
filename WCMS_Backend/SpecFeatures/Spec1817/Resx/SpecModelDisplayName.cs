...
namespace WCMS.SpecFeatures.Spec1817.Resx
{
    public static class SpecModelDisplayName
    {
        ...
        public const string Spec_Specification = "Spec_Specification";
        public const string Spec_Headstock = "Spec_Headstock";
        public const string Spec_Backboard = "Spec_Backboard";
        public const string Spec_ScaleLength = "Spec_ScaleLength";
        public const string Spec_Bridge = "Spec_Bridge";
        public const string Spec_BodyForm = "Spec_BodyForm";
