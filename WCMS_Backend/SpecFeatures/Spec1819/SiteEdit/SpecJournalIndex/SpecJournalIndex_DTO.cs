...
using WCMS.SpecFeatures.Spec1817.SiteEdit.SpecMusical;
...
namespace WCMS.SpecFeatures.Spec1819.SiteEdit.SpecJournalIndex
{
    ...
    {
        [LibDesc(SpecModelDisplayName.SpecJournalIndex)] public SpecJournalIndexModel_DTO SpecJournalIndex { get; set; } = new ();
