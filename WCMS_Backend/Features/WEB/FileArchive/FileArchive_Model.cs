...
public class FileArchive : HeaderModel
{
    ...
    /// </summary>
[Required, Key]
[LibStr(ApiFieldMode.ReadOnly, SysLengthParam.ID, DisplayName.FileArchiveId)]
...
public FileManageModel FileSrc { get; set; }
    ...
    /// 語系 SysEnum.Lang
    /// </summary>
[LibStr(ApiFieldMode.ReadWrite, SysLengthParam.Title, DisplayName.FileArchive_FileName)]
