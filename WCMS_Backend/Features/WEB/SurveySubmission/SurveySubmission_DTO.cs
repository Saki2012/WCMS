...
public class SurveySubmissionRequest_DTO
{
    ...
    /// 問卷代碼
    /// </summary>
    [LibDesc(DisplayName.SurveyId), StringLength(SysLengthParam.ID)] public string? SurveyId { get; set; }
    /// <summary>
    /// 語系
    /// </summary>
    ...
    /// 用戶名稱
    /// </summary>
    [LibDesc(DisplayName.Common_Name), StringLength(SysLengthParam.Name)] public string? UserName { get; set; } = string.Empty;
    /// <summary>
    /// 聯絡電話
    /// </summary>
    [LibDesc(DisplayName.Common_HomePhone), StringLength(SysLengthParam.Phone)] public string? ContactPhone { get; set; } = string.Empty;
    /// <summary>
    /// Email
    /// </summary>
    [LibDesc(DisplayName.Common_Email), StringLength(SysLengthParam.Email)] public string? Email { get; set; } = string.Empty;
    /// <summary>
