...
public class Timeline: HeaderModel
{
    ...
    /// </summary>
[Key]
[LibStr(ApiFieldMode.ReadOnly, SysLengthParam.ID, DisplayName.TimelineId)]
public string TimelineId { get; set; } = string.Empty;
    /// <summary>
    /// 紀事表名稱
    /// </summary>
[LibStr(ApiFieldMode.ReadWrite, SysLengthParam.Name, DisplayName.TimelineName)]
...
/// 紀事發生日
/// </summary>
public class TimelineItem : DetailModel
{
    /// <summary>
    /// 紀事代碼
    /// </summary>
...
/// 紀事說明
/// </summary>
public class TimelineLangDetail : DetailModel
{
    /// <summary>
    /// 紀事代碼
    /// </summary>
...
public LangCode Lang { get; set; }
    ...
    /// 事件標題
    /// </summary>
[LibStr(ApiFieldMode.ReadWrite, SysLengthParam.Title, DisplayName.Timeline_Title)]
