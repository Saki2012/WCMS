...
## 2025/07/22
**進度**
- [x] 調整QueryData/Update/Delete/Invalid 用UID(InternalId)當作表單唯一條件處理
- [x] 透過UID找到資料主鍵->再透過主鍵找完整資料
...
**進度**
- [x] 調整API傳參接收資料格式
    - SelectFields可以找到明細資料
    - Where Condition可以透過明細再來辨識標頭的資料 (暫還沒做過濾明細非該比條件的內容)
- [ ] 移轉舊站資料至新專案上 (35%)
    - 確定資料產生格式與方式
